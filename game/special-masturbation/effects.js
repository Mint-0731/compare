...
function masturbationEffects() {
	...
	const toyDisplay = (toy1, toy2) => {
		if (toy1 && toy2) return (toy1.colour ? toy1.colour + " " : "") + toy1.name + "과 " + (toy2.colour ? toy2.colour + " " : "") + toy2.name;
			...
			if (V.orgasmdown >= 2) {
				...
				if (V.corruptionMasturbationCount <= 0) {
					...
					if (V.awareness < 200) {
						...
						if (V.mouth === "mpenis") {
							sWikifier(
								'<span class="green">당신 귓속의 슬라임이 통제력을 잃어버림에 따라, 당신은 페니스를 입에서 빼서 치운다.</span>'
							);
							fragment.append(" ");
							...
							sWikifier('<span class="green">당신 귓속의 슬라임이 통제력을 잃어버림에 따라, 당신은 페니스를 치운다.</span>');
							fragment.append(" ");
							V.mouthactiondefault = "rest";
							V.mouthaction = 0;
							V.mouth = 0;
							...
							sWikifier(
								'<span class="green">당신 귓속의 슬라임이 통제력을 잃어버림에 따라, 당신은 기생충 정조대 페니스를 치운다.</span>'
							);
							fragment.append(" ");
							V.mouthactiondefault = "rest";
							V.mouthaction = 0;
							...
							sWikifier('<span class="green">당신 귓속의 슬라임이 통제력을 잃어버림에 따라, 당신은 질을 치운다.</span>');
							fragment.append(" ");
							V.mouthactiondefault = "rest";
							V.mouthaction = 0;
							V.mouth = 0;
							...
							if (V.mouth === "mbreast") {
								sWikifier(
									'<span class="green">>당신 귓속의 슬라임이 통제력을 잃어버림에 따라, 당신은 입에서 당신의 <<breasts>>을 치운다.</span>'
								);
							} else {
								sWikifier(
									'<span class="green">>당신 귓속의 슬라임이 통제력을 잃어버림에 따라, 당신은 <<breasts>>을 짜내는 것을 그만둔다.</span>'
								);
							}
							fragment.append(" ");
							if (V.mouth === "mbreast") {
	...
	if (otherVariables.additionalEffect.hands === "ballplayeffects" && V.worn.genitals.name !== "chastity parasite") {
		if (V.arousal >= V.arousalmax * (4 / 5) || (V.earSlime.focus === "impregnation" && V.earSlime.growth >= 100)) {
			if (genitalsExposed()) {
				sWikifier('당신의 페니스가 격렬하게 움직이며, <span class="pink">쿠퍼액이 끝에서 튀어오른다.</span>');
			} else {
				sWikifier('당신의 페니스가 격렬하게 움직이며, <span class="pink">쿠퍼액이 당신의 속옷을 통해 새어나온다.</span>');
			}
		} else if (V.arousal >= V.arousalmax * (3 / 5)) {
			if (genitalsExposed()) {
				sWikifier('당신의 페니스가 격렬하게 움직이며, <span class="pink">쿠퍼액이 귀두에서 방울진다.</span>');
			} else {
				sWikifier('당신의 페니스가 격렬하게 움직이며, <span class="pink">쿠퍼액이 당신의 속옷 위에 짙은 자국을 만든다.</span>');
			}
		} else if (V.arousal >= V.arousalmax * (2 / 5)) {
			sWikifier("그 압력이 당신의 페니스를 고동치게 한다.");
		} else {
			T.penisStateDescribed = true;
			sWikifier("그 압력이 당신의 페니스를 씰룩거리게 한다.");
		}
		fragment.append(" ");
	}
	...
	if (
		...
		if (V.arousal >= V.arousalmax * (4 / 5) || (V.earSlime.focus === "impregnation" && V.earSlime.growth >= 100)) {
			if (genitalsExposed()) {
				sWikifier(
					`당신의 스트랩온이 격렬하게 움직이며, <span class="pink">쿠퍼액이 끝에서 튀어${
						V.bugsinside && V.player.penissize >= 0 ? "올라 그 위를 기어다니는 벌레 몇 마리를 뒤덮는다" : "오른다"
					}.</span>`
				);
			} else {
				sWikifier('당신의 스트랩온이 격렬하게 움직이며, <span class="pink">쿠퍼액이 당신의 속옷을 통해 새어나온다.</span>');
			}
		} else {
			if (genitalsExposed()) {
				sWikifier(
					`당신의 스트랩온이 격렬하게 움직이며, <span class="pink">쿠퍼액이 귀두에서 방울져${
						V.bugsinside && V.player.penissize >= 0 ? "나와 그 위를 기어다니는 벌레 몇 마리를 뒤덮는다" : " 나온다"
					}.</span>`
				);
			} else {
				sWikifier('당신의 스트랩온이 격렬하게 움직이며, <span class="pink">쿠퍼액이 당신의 속옷 위에 짙은 자국을 만든다.</span>');
			}
		}
		fragment.append(" ");
	}
	...
	if (V.worn.genitals.name === "chastity parasite" && V.earSlime.vibration > 0) {
		...
		if (V.earSlime.vibration === 1) {
			...
			sWikifier('<span class="lewd">당신의 기생충 정조대가 페니스 주위에서 부드럽게 진동한다.</span>');
		} else if (V.earSlime.vibration <= 20) {
			sWikifier('<span class="lewd">당신의 기생충 정조대가 페니스 주위에서 진동한다.</span>');
		} else if (V.earSlime.vibration <= 30) {
			sWikifier(
				`<span class="lewd">당신의 기생충 정조대가 페니스와 ${V.mouth === "mchastityparasiteentrance" ? "_trPost 혓바닥" : ""} 위에서 진동한다.</span>`
			);
		} else {
			sWikifier(
				`<span class="lewd">당신의 기생충 정조대가 페니스와 ${
					V.mouth === "mchastityparasiteentrance" ? "혓바닥" : ""
				} 위에서 강하게 진동한다.</span>`
			);
		}
	...
	if (V.player.vaginaExist && V.vaginaArousalWetness >= 60) {
		if (V.worn.under_lower.vagina_exposed && V.worn.lower.vagina_exposed) {
			...
			if (T.lube_released) {
				sWikifier('<span class="pink">애액이 당신의 질에서 새어나온다.</span>');
			}
		} else if (V.worn.under_lower.vagina_exposed === 0 && V.underlowerwetstage < 3) {
			sWikifier(`<span class="pink">애액이 당신의 질에서 새어나와 당신의 속옷을 적신다.</span>`);
			wikifier("underlowerwet", 1);
		} else if (V.worn.lower.vagina_exposed === 0) {
			sWikifier(
				`<span class="pink">애액이 당신의 질에서 새어나와<<if V.underlowerwet gte 60>>, 당신의 속옷을 흠뻑 적시고 배어나와,<</if>> 당신의 치마를 적신다.</span>`
			);
		} else {
			sWikifier('<span class="pink">애액이 당신의 질에서 새어나와 당신의 옷을 적신다.</span>');
		}
		fragment.append(" ");
	}
...
function masturbationEffectsArms(
	...
	switch (V[armAction]) {
		case "moverupper":
			...
			if (V.worn.over_upper.open) {
				...
				sWikifier(`당신은 외투를 끌어내려, <span class="lewd">당신의 <<breasts>>을 노출시킨다.</span>`);
			} else {
				V.worn.over_upper.state = "chest";
				sWikifier(`당신은 외투를 끌어올려, <span class="lewd">당신의 <<breasts>>을 노출시킨다.</span>`);
			}
		...
		case "mupper":
			...
			if (V.worn.upper.open) {
				...
				sWikifier(`당신은 윗옷을 끌어내려, <span class="lewd">당신의 <<breasts>>을 노출시킨다.</span>`);
			} else {
				V.worn.upper.state = "chest";
				sWikifier(`당신은 윗옷을 끌어올려, <span class="lewd">당신의 <<breasts>>을 노출시킨다.</span>`);
			}
			wikifier("upperstrip");
			fragment.append(" ");
			break;
		case "munder_upper":
			...
			if (V.worn.under_upper.open) {
				...
				if (V.player.breastsize >= 3) {
					sWikifier(`당신이 속옷을 끌어내리자 <span class="lewd">당신의 <<breasts>>이 털썩 튀어나온다.</span>`);
				} else {
					sWikifier(`당신은 속옷을 끌어내려, <span class="lewd">당신의 <<breasts>>을 노출시킨다.</span>`);
				}
			} else {
				V.worn.under_upper.state = "chest";
				if (V.player.breastsize >= 3) {
					sWikifier(`당신이 속옷을 끌어올리자 <span class="lewd">당신의 <<breasts>>이 털썩 튀어나온다.</span>`);
				} else {
					sWikifier(`당신은 속옷을 끌어올려, <span class="lewd">당신의 <<breasts>>을 노출시킨다.</span>`);
				}
			}
		...
		case "moverlower":
			...
			if (setup.clothes.over_lower[clothesIndex("over_lower", V.worn.over_lower)].skirt) {
				...
				sWikifier(`당신은 하의를 잡아올려, <span class="lewd">당신의 속옷을 노출시킨다.</span>`);
			} else {
				V.worn.over_lower.state = "thighs";
				sWikifier(`당신은 하의를 끌어내려, <span class="lewd">당신의 속옷을 노출시킨다.</span>`);
			}
		...
		case "mlower":
			...
			if (setup.clothes.lower[clothesIndex("lower", V.worn.lower)].skirt) {
				...
				sWikifier(`당신은 치마를 잡아올려, <span class="lewd">당신의 하반신을 노출시킨다.</span>`);
			} else {
				V.worn.lower.state = "thighs";
				sWikifier(`당신은 치마를 끌어내려, <span class="lewd">당신의 하반신을 노출시킨다.</span>`);
			}
			wikifier("lowerstrip");
			fragment.append(" ");
			break;
		case "munder":
			...
			sWikifier(`당신은 속옷을 끌어내려, <span class="lewd">당신의 질을 노출시킨다.</span>`);
	...
	if (V.vaginaaction === "mpenisflowerpenetrate" || V.vaginause === "mpenisflowerpenetrate") {
		...
		if (V.mouth === "mvaginaentrance") {
			...
			V.mouthaction = 0;
			V.mouth = 0;
			fragment.append(span("당신은 당신의 질에서 입을 치운다."));
		}
	...
	if (V.vaginause === "mdildopenetrate" || V.anususe === "mdildopenetrate") {
		if (["mvaginaentrancedildo", "mvaginadildo", "manusentrancedildo", "manusdildo"].includes(V.leftarm)) {
			if (V.leftarm.includes("vagina")) {
				fragment.append(span(`당신은 그것이 닿기 어렵다는 것을 알아차리고 ${toyDisplay(selectedToy("left"))}를 질에서 치운다.`, "red"));
			} else {
				fragment.append(span(`당신은 그것이 닿기 어렵다는 것을 알아차리고 ${toyDisplay(selectedToy("left"))}를 항문에서 치운다.`, "red"));
			}
			fragment.append(" ");
		...
		if (["mvaginaentrancedildo", "mvaginadildo", "manusentrancedildo", "manusdildo"].includes(V.rightarm)) {
			if (V.rightarm.includes("vagina")) {
				fragment.append(span(`당신은 그것이 닿기 어렵다는 것을 알아차리고 ${toyDisplay(selectedToy("right"))} 질에서 치운다.`, "red"));
			} else {
				fragment.append(span(`당신은 그것이 닿기 어렵다는 것을 알아차리고 ${toyDisplay(selectedToy("right"))} 항문에서 치운다.`, "red"));
			}
			fragment.append(" ");
	...
	switch (V[armAction]) {
			...
			if (V.worn.over_upper.exposed >= 2 && V.worn.upper.exposed >= 2 && V.worn.under_upper.exposed >= 1) {
				...
				if (V.lactating && V.settings.breastFeedingEnabled === true && V.bugsinside) {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier(
							"당신은 <<breasts>>을 견딜 수 있는 한 많이 쥐어짜, 그 위를 기어다니는 벌레들을 위해 가능한 한 많이 모유를 짜낸다."
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						sWikifier("당신은 <<breasts>>을 애무하며 그 위를 기어다니는 벌레들을 가능한 많이 당신의 젖꼭지로 다가오도록 한다.");
					} else {
						sWikifier("당신은 <<breasts>>을 비비면서, 벌레들이 그 위를 기어다녀도 음란한 따뜻함이 점점 커지는 것을 느낀다.");
					}
					...
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						...
						sWikifier(
							"당신은 당신의 <<breasts>>을 애무하며 손가락으로 유륜 주위를 둥글게 문지르면서, 가끔씩 젖꼭지를 살짝 꼬집는다."
						);
					} else {
						sWikifier("당신은 당신의 <<breasts>>을 쓰다듬으며 손가락 사이로 젖꼭지를 비비면서, 음란한 따뜻함이 점점 커지는 것을 느낀다.");
					}
				} else if (V.player.breastsize <= 5) {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier(
							"당신이 <<breasts>>을 감싸고 당신의 민감한 젖꼭지를 견딜 수 있는 한 많이 희롱하자, 손가락이 스칠 때 마다 흥분의 충격이 당신의 몸을 타고 달린다."
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						sWikifier(
							"당신은 당신의 <<breasts>>을 애무하며 손가락으로 유륜 주위를 둥글게 문지르면서, 가끔씩 젖꼭지를 살짝 꼬집는다."
					...
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier(
							"당신은 <<breasts>>을 감싸고 당신의 민감한 젖꼭지를 견딜 수 있는 한 많이 희롱한다. 손가락이 스칠 때 마다 흥분의 충격이 당신의 몸을 타고 달린다."
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						sWikifier(
							"당신은 당신의 <<breasts>>을 애무하며 손가락으로 유륜 주위를 둥글게 문지르면서, 가끔씩 젖꼭지를 살짝 꼬집는다."
				...
				if (V.player.breastsize <= 2) {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier(
							"당신의 유두가 자극에 대한 반응으로 긴장하여, 당신의 윗옷 안에서 발기한 채로 서 있다. 당신은 그것을 견딜 수 있는 한 많이 희롱하고 꼬집는다."
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						sWikifier("당신은 당신의 <<breasts>>을 애무하며 윗옷을 통해 당신의 젖꼭지를 꼬집는다.");
					} else {
						sWikifier(
							"당신은 당신의 <<breasts>>을 쓰다듬으며 손가락 사이로 당신의 젖꼭지를 비빈다. 비록 당신의 윗옷이 사이에 있지만, 좋은 기분이 든다."
						);
					}
				} else if (V.player.breastsize <= 5) {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier(
							"당신의 유두가 자극에 대한 반응으로 긴장하여, 당신의 윗옷 안에서 발기한 채로 서 있다. 당신은 당신의 <<breasts>>을 감싸고 당신의 민감한 젖꼭지를 견딜 수 있는 한 많이 가지고 논다."
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						sWikifier("당신은 당신의 <<breasts>>을 애무하며 윗옷을 통해 당신의 젖꼭지를 꼬집는다.");
					} else {
		...
		case "mbreasthold":
			...
			if (V.mouthaction === "mbreastentrance") {
				...
				fragment.append(Wikifier.wikifyEval(`당신은 반대쪽 <<breasts>>을 잡고 그 끝을 당신의 입으로 가져온다.`));
			} else {
				fragment.append(Wikifier.wikifyEval(`당신은 ${doubleAction ? "두 <<breasts>>을" : "<<breasts>>을"} 잡고 있다.`));
			}
			break;
		case "mbreastfondle":
			if (V.mouthaction === "mbreastentrance") {
				...
				if (V.worn.over_upper.exposed >= 2 && V.worn.upper.exposed >= 2 && V.worn.under_upper.exposed >= 1) {
					...
					if (V.lactating && V.settings.breastFeedingEnabled === true && V.bugsinside) {
						if (V.arousal >= (V.arousalmax / 5) * 4) {
							sWikifier(
								"당신은 손으로 감싼 <<breasts>>을 견딜 수 있는 한 많이 쥐어짜, 그 위를 기어다니는 벌레들을 위해 가능한 한 많이 모유를 짜낸다."
							);
						} else if (V.arousal >= (V.arousalmax / 5) * 3) {
							sWikifier("당신은 손으로 감싼 <<breasts>>을 애무하며 그 위를 기어다니는 벌레들을 가능한 많이 당신의 젖꼭지로 다가오도록 한다.");
						} else {
							sWikifier("당신은 손으로 감싼 <<breasts>>을 비비면서, 벌레들이 그 위를 기어다녀도 음란한 따뜻함이 점점 커지는 것을 느낀다.");
						}
					} else {
						if (V.arousal >= (V.arousalmax / 5) * 4) {
							fragment.append(
							...
							sWikifier("당신은 손으로 감싼 <<breasts>>을 애무하며 가끔씩 젖꼭지를 살짝 꼬집는다.");
						} else {
							sWikifier("당신은 손으로 감싼 <<breasts>>을 쓰다듬으며 손가락 사이로 젖꼭지를 비비면서, 음란한 따뜻함이 점점 커지는 것을 느낀다.");
						}
					}
				} else {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier(
							"당신의 유두가 자극에 대한 반응으로 긴장하여, 당신의 윗옷 안에서 발기한 채로 서 있다. 당신은 <<breasts>>을 감싸고 당신의 민감한 <<breasts>>과 젖꼭지를 견딜 수 있는 한 많이 쥐어짠다."
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						sWikifier("당신은 손으로 감싼 <<breasts>>을 쥐어짜며 윗옷을 통해 당신의 젖꼭지를 꼬집는다.");
					} else {
						sWikifier(
							"당신은 손으로 감싼 <<breasts>>을 애무하며 손가락 사이로 당신의 젖꼭지를 비빈다. 비록 당신의 윗옷이 사이에 있지만, 좋은 기분이 든다."
						);
					}
				}
					...
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						fragment.append(
							span(
								`당신은${
									handsOn > 1 ? " 양쪽" : ""
								} 젖꼭지에 붙어있는 기생충을 견딜 수 있는 한 많이 꼬집고, 비틀고, 잡아당기며, ${handsOn > 1 ? "그것들이" : "그것이"} 당신을 더 세게 물어뜯는 아픔과 쾌감을 즐긴다.`
							)
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						fragment.append(
							span(`당신은${handsOn > 1 ? " 양쪽" : ""} 젖꼭지에 붙어있는 기생충을 견딜 수 있는 한 많이 꼬집는다.`)
						);
					} else {
						fragment.append(span(`당신은${handsOn > 1 ? " 양쪽" : ""} 젖꼭지에 붙어있는 기생충을 살짝 꼬집는다.`));
					}
				} else {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						fragment.append(
		...
		case "mvaginachastity":
			...
			if (V[armAction] !== "mchastity" && (!doubleAction || V[armAction] === V[otherArmAction])) {
				altText.target = V[armAction] === "mpenischastity" ? "페니스는" : "질은";
			}
			sWikifier(
				`당신은 손가락을 당신의 정조대 아래로 집어넣으려 하지만, 실패한다. 당신의 ${altText.target} 당신의 손길을 갈망하지만, 당신이 할 수 있는 것은 아무것도 없다.<<gstress>>`
			);
		...
		case "mpenisentrance":
			...
			if (earSlimeDefy()) {
				...
				if (!V.worn.over_lower.vagina_exposed) {
					sWikifier(`당신은 손가락을 당신의 페니스 위에서 움직이며${calculatePenisBulge() ? ", 속옷 아래의 툭 튀어나온 부분을 느낀다" : ""}.`);
				} else if (!V.worn.lower.vagina_exposed) {
					sWikifier(`당신은 손가락을 당신의 페니스 위에서 움직이며${calculatePenisBulge() ? ", 속옷 아래의 툭 튀어나온 부분을 느낀다" : ""}.`);
				} else if (!V.worn.under_lower.vagina_exposed) {
					sWikifier(`당신은 손가락을 당신의 페니스 위에서 움직이며${calculatePenisBulge() ? ", 속옷 아래의 툭 튀어나온 부분을 느낀다" : ""}.`);
				} else {
					sWikifier(`당신은 손가락을 당신의 페니스 위에서 움직이다 잠시 움직임을 멈춘다. <span class="red">당신은 아무것도 느낄 수가 없었다.</span>`);
				}
			} else {
				...
				if (!V.worn.over_lower.vagina_exposed) {
					sWikifier(
						`<span class="blue">당신은 손가락을 당신의 페니스 위에서 움직이며${
							calculatePenisBulge() ? ", 속옷 아래의 툭 튀어나온 부분을 느낀다" : ""
						}.</span>`
					);
				} else if (!V.worn.lower.vagina_exposed) {
					sWikifier(
					...
					sWikifier('<span class="blue">당신은 손가락을 당신의 페니스 위에서 움직이며 기대감에 몸을 떤다.</span>');
				}
			}
			break;
		case "mchastityparasiteentrance":
			...
			if (V.earSlime.defyCooldown) {
				...
				if (!V.worn.over_lower.vagina_exposed) {
					sWikifier(
						`<span class="blue">당신은 손가락을 기생충 정조대 페니스 위에서 움직이며${
							calculatePenisBulge() ? ", 속옷 아래의 툭 튀어나온 부분을 느낀다" : ""
						}.</span>`
					);
				} else if (!V.worn.lower.vagina_exposed) {
					...
					sWikifier(`당신은 손가락을 기생충 정조대 페니스 위에서 움직이다 잠시 움직임을 멈춘다. <span class="red">당신은 아무것도 느낄 수가 없었다.</span>`);
				}
			} else {
				...
				if (!V.worn.over_lower.vagina_exposed) {
					...
					sWikifier('<span class="blue">당신은 손가락을 기생충 정조대 페니스 위에서 움직이며 기대감에 몸을 떤다.</span>');
				}
				if (!V.earSlime.vibration) {
					V.earSlime.vibration = 1;
					wikifier("arousal", 50, "masturbationGenital");
					sWikifier(' <span class="lewd">그것은 당신의 페니스 주위에서 부드럽게 고동치기 시작한다.</span>');
				}
			}
			break;
		case "mpenisglans":
			...
			if (earSlimeDefy()) {
				...
				wikifier("pain", 1);
				additionalEffect.earSlimeDefy.pushUnique(V.player.virginity.penile === true ? "동정 페니스" : "페니스");
				...
				if (V.player.virginity.penile === true) {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						...
						fragment.append(
							span("당신은 동정 페니스의 끝부분을 손바닥 안에 잡고 당신의 엄지손가락으로 쿠퍼액으로 덮인 포피를 열정적으로 비벼댄다.")
						);
					}
				} else {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						...
						sWikifier("당신은 쿠퍼액으로 뒤덮인 페니스를 당신의 손바닥 안에 잡고 포피를 당신의 귀두에 대고 비빈다.");
					}
				}
			} else {
				...
				if (handsOn === 2) {
					if (V.player.virginity.penile === true) {
						if (V.arousal >= (V.arousalmax / 5) * 4) {
							...
							fragment.append(span("당신은 동정 페니스의 끝부분을 손바닥 안에 잡고 당신의 엄지손가락으로 포피를 부드럽게 비빈다."));
						}
					} else {
						if (V.arousal >= (V.arousalmax / 5) * 4) {
							...
							sWikifier("당신은 페니스를 당신의 손바닥 안에 잡고 포피를 당신의 귀두에 대고 비빈다.");
						}
					}
				} else {
					if (V.player.virginity.penile === true) {
		...
		case "mpenisshaft":
			...
			if (earSlimeDefy()) {
				...
				if (V.player.virginity.penile === true) {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						fragment.append(
							span("당신이 쿠퍼액으로 뒤덮인 동정 페니스를 손가락들로 거칠게 비벼대자, 음란한 따뜻함이 몸 전체에서 생겨난다.")
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						fragment.append(span("당신은 손가락들로 당신의 쿠퍼액으로 뒤덮인 동정 페니스를 육봉 끝에서 끝까지 열정적으로 위아래로 비벼댄다."));
					} else {
						sWikifier("당신은 손가락들을 당신의 페니스 아래쪽으로 움직이며, 음란한 따뜻함을 즐긴다.");
					}
				} else {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier("당신이 당신의 페니스를 육봉 끝에서 끝까지 거칠게 위아래로 펌프질하자, 넘쳐나는 쿠퍼액이 그 끝에서 튀어 날아간다.");
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						fragment.append(
							span("당신이 손가락들을 쿠퍼액으로 뒤덮인 육봉의 위아래로 열정적으로 움직이자, 음란한 따뜻함이 몸 전체에서 생겨난다.")
						);
					} else {
						sWikifier("당신이 당신의 페니스를 육봉 끝에서 끝까지 애무하자, 음란한 따뜻함이 생겨난다.");
					}
				}
			} else {
				wikifier("arousal", 200 * handsOn, "masturbationPenis");
				if (handsOn === 2) {
					if (V.player.virginity.penile === true) {
						if (V.arousal >= (V.arousalmax / 5) * 4) {
							fragment.append(span("당신은 손가락들로 당신의 동정 페니스를 포피가 허용하는 한 거칠게 비벼댄다."));
						} else if (V.arousal >= (V.arousalmax / 5) * 3) {
							fragment.append(span("당신은 손가락들로 당신의 동정 페니스를 육봉 끝에서 끝까지 위아래로 비벼댄다."));
						} else {
							sWikifier("당신은 손가락들을 당신의 페니스 아래쪽으로 움직이며, 그 느낌을 즐긴다.");
						}
					} else {
						if (V.arousal >= (V.arousalmax / 5) * 4) {
							sWikifier("당신은 당신의 페니스를 육봉 끝에서 끝까지 위아래로 펌프질한다.");
						} else if (V.arousal >= (V.arousalmax / 5) * 3) {
							fragment.append(span("당신이 손가락들을 당신의 육봉 위아래로 움직이면서, 살짝 자극하자 음란한 따뜻함이 생겨난다."));
						} else {
							sWikifier("당신은 천천히 당신의 페니스를 육봉 끝에서 끝까지 애무한다.");
						}
					}
				} else {
					if (V.player.virginity.penile === true) {
		...
		case "mpenisstop":
			...
			if (doubleAction) {
				V[otherArm + "arm"] = 0;
				sWikifier('<span class="lblue">당신은 양손을 당신의 페니스에서 치운다.</span>');
			} else {
				sWikifier(`<span class="lblue">당신은 한쪽 손을 당신의 페니스에서 치운다.</span>`);
			}
			break;
		case "mchastityparasiterub":
			...
			if (earSlimeDefy()) {
				...
				additionalEffect.earSlimeDefy.pushUnique(V.player.virginity.penile === true ? "동정 페니스" : "페니스");
				sWikifier(`당신은 부드럽게 기생충 페니스를 애무한다.`);
				...
				if (V.arousal >= (V.arousalmax / 5) * 3) {
					wikifier("arousal", 500, "masturbationPenis");
					sWikifier(
						`당신이 기생충 페니스를 희롱하려 애쓰자, 각각, <span class="lewd">기생충이 쾌감의 물결을 당신의 몸 전체로 보내고</span>, 당신은 그것을 거의 참고 있기가 힘들다.`
					);
				} else {
					sWikifier(
						`당신이 ${altText.eagerly} 기생충 페니스를 애무하자, 각각, <span class="lewd">기생충이 쾌감의 물결을 당신의 몸 전체로 보낸다.</span>`
					);
				}
			} else {
				wikifier("arousal", 200 * handsOn, "masturbationPenis");
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					...
					fragment.append(
						span(
							`당신은 가능한 거칠게 기생충 페니스를 희롱하며, 당신의 ${
								V.player.virginity.penile === true ? "동정 페니스" : "페니스"
					...
					fragment.append(
						span(
							`당신이 부드럽게 기생충 페니스를 애무하자, 그것은 당신의 ${
								V.player.virginity.penile === true ? "동정 페니스" : "페니스"
							}에 직접적으로 쾌감을 전해준다.`
						)
					);
		...
		case "mchastityparasitesqueeze":
			...
			if (earSlimeDefy()) {
				...
				wikifier("pain", 1 * handsOn);
				additionalEffect.earSlimeDefy.pushUnique(V.player.virginity.penile === true ? "동정 페니스" : "페니스");
				sWikifier(`당신은 부드럽게 기생충 페니스를 쥐어짠다.`);
				...
				if (V.arousal >= (V.arousalmax / 5) * 3) {
					wikifier("arousal", 500, "masturbationPenis");
					sWikifier(
						`당신이 기생충 페니스를 쥐어짜려 애쓰자, 각각, <span class="lewd">기생충이 쾌감의 물결을 당신의 몸 전체로 보내고</span>, 당신은 그것을 거의 참고 있기가 힘들다.`
					);
				} else {
					sWikifier(
						`당신이 ${altText.eagerly} 기생충 페니스를 쥐어짜자, 각각, <span class="lewd">기생충이 쾌감의 물결을 당신의 몸 전체로 보낸다.</span>`
					);
				}
			} else {
				wikifier("arousal", 200 * handsOn, "masturbationPenis");
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					...
					fragment.append(
						span(`당신은 기생충 페니스를 쥐어짜며, 당신의 ${V.player.virginity.penile === true ? "동정 페니스" : "페니스"}도 동시에 쥐어짠다.`)
					);
				} else {
					fragment.append(
						span(
							`당신은 부드럽게 기생충 페니스를 쥐어짜며, 그것이 둘러싸고 있는 ${V.player.virginity.penile === true ? "동정 페니스" : "페니스"}를 느낀다.`
						)
					);
				}
			}
		...
		case "mchastityparasitestop":
			...
			if (doubleAction) {
				...
				sWikifier(`<span class="lblue">당신은 한쪽 손을 기생충 정조대에서 치운다.</span>`);
			}
			break;
		case "mballsstop":
			clearAction("mrest");
			...
			if (doubleAction) {
				...
				fragment.append(span(`당신은 한쪽 손을 당신의 고환에서 치운다.`, "lblue"));
			}
			break;
		case "mballsfondle":
			clearAction();
			if (earSlimeDefy()) {
				...
				sWikifier(`무언가 느끼도록 당신은 거칠게 고환을 더듬으라고 강요된다.`);
			} else {
				wikifier("arousal", 100 * handsOn, "masturbationPenis");
				if (handsOn === 2) {
					if (V.arousal >= V.arousalmax * (4 / 5)) {
						fragment.append(
							span(
								`당신은 양손으로 당신의 고환을 더듬으며 그것이 당신의 페니스 밑동에서 긴장하며 꽉 조이는 느낌을 즐긴다.`
							)
						);
					} else if (V.arousal >= V.arousalmax * (3 / 5)) {
						fragment.append(span(`당신은 양손으로 당신의 고환을 애무하며 그 간지러운 느낌을 즐긴다.`));
					} else if (V.arousal >= V.arousalmax * (2 / 5)) {
						fragment.append(span(`당신은 양손 안의 고환을 이리저리 움직이며 그 무게감을 즐긴다.`));
					} else {
						fragment.append(span(`당신은 양손 안의 고환을 이리저리 굴린다.`));
					}
				} else {
					altText.oneOfYour = V.ballssize <= 0 ? `당신의 양쪽 고환을` : additionalEffect.hands ? "다른쪽을" : `당신의 한쪽 고환을`;
					if (V.arousal >= V.arousalmax * (4 / 5)) {
						sWikifier(
							`당신은 한쪽 손으로 ${altText.oneOfYour} 더듬으며 그것이 당신의 페니스 밑동에서 긴장하며 꽉 조이는 느낌을 즐긴다.`
						);
					} else if (V.arousal >= V.arousalmax * (3 / 5)) {
						fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 애무하며 그 간지러운 느낌을 즐긴다.`));
					} else if (V.arousal >= V.arousalmax * (2 / 5)) {
						fragment.append(span(`당신은 손 안의 ${altText.oneOfYour} 이리저리 움직이며 그 무게감을 즐긴다.`));
					} else {
						fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 쓰다듬는다.`));
					}
				}
		...
		case "mballssqueeze":
			...
			if (earSlimeDefy()) {
				...
				wikifier("pain", 1);
				additionalEffect.earSlimeDefy.pushUnique("balls");
				sWikifier(`무언가 느끼도록 당신은 거칠게 고환을 쥐어짜라고 강요된다.`);
			} else {
				wikifier("arousal", 200 * handsOn, "masturbationPenis");
				...
				if (handsOn === 2) {
					switch (V.ballssize) {
						case 1:
						case 2:
							fragment.append(span(`당신은 양손으로 당신의 고환을 감싸고 ${altText.gently} 쥐어짠다.`));
							break;
						case 3:
							fragment.append(span(`당신은 양손으로 당신의 고환을 감싸고 ${altText.gently} 쥐어짠다.`));
							break;
						case 4:
							fragment.append(span(`당신은 양손으로 ${altText.gently} 당신의 고환을 쥐어짠다.`));
							break;
						default:
					...
					switch (V.ballssize) {
						case 1:
						case 2:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 감싸고 ${altText.gently} 쥐어짠다.`));
							break;
						case 3:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 감싸고 ${altText.gently} 쥐어짠다.`));
							break;
						case 4:
							...
							break;
						default:
							fragment.append(span(`당신은 손으로 당신의 고환을 감싸고 ${altText.gently} 쥐어짠다.`));
							break;
					}
				}
				additionalEffect.hands = "ballplayeffects";
			...
			if (V.earSlime.defyCooldown && V.earSlime.growth >= 100) {
				if (handsOn === 2) {
					switch (V.ballssize) {
						case 1:
						case 2:
							fragment.append(span(`당신은 고환을 각각의 손에 한쪽씩 나눠잡는다`));
							break;
						case 3:
							fragment.append(span(`당신은 고환을 각각의 손에 한쪽씩 나눠잡는다. 그것들은 당신의 손바닥에 딱 들어온다`));
							break;
						case 4:
							fragment.append(span(`당신은 고환을 각각의 손에 한쪽씩 나눠잡는다. 당신은 간신히 그것들을 양손으로 감싼다`));
							break;
						default:
							fragment.append(span("이 문장은 나오지 말아야 합니다.", "red"));
							break;
					...
					switch (V.ballssize) {
						case 1:
						case 2:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 잡는다.`));
							break;
						case 3:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 잡는다. 그것은 당신의 손바닥에 딱 들어온다`));
							break;
						case 4:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 잡는다. 당신은 간신히 그것을 손으로 감싼다`));
							break;
						default:
							fragment.append(span(`당신은 손으로 당신의 양쪽 고환을 가뿐하게 잡는다.`));
							break;
					}
				}
				...
				if (handsOn === 2) {
					switch (V.ballssize) {
						case 1:
						case 2:
							fragment.append(span(`당신은 고환을 각각의 손에 한쪽씩 나눠잡는다.`, "blue"));
							break;
						case 3:
							fragment.append(span(`당신은 고환을 각각의 손에 한쪽씩 나눠잡는다. 그것들은 당신의 손바닥에 딱 들어온다.`, "blue"));
							break;
						case 4:
							fragment.append(span(`당신은 고환을 각각의 손에 한쪽씩 나눠잡는다. 당신은 간신히 그것들을 양손으로 감싼다.`, "blue"));
							break;
						default:
							fragment.append(span("이 문장은 나오지 말아야 합니다.", "red"));
							break;
					...
					switch (V.ballssize) {
						case 1:
						case 2:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 잡는다.`, "blue"));
							break;
						case 3:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 잡는다. 그것은 당신의 손바닥에 딱 들어온다.`, "blue"));
							break;
						case 4:
							fragment.append(span(`당신은 손으로 ${altText.oneOfYour} 잡는다. 당신은 간신히 그것을 손으로 감싼다.`, "blue"));
							break;
						default:
							fragment.append(span(`당신은 손으로 당신의 양쪽 고환을 가뿐하게 잡는다.`, "blue"));
							break;
					}
				}
				additionalEffect.hands = "ballplayeffects";
		...
		case "mpenisW":
			...
			if (V.worn.genitals.name === "chastity parasite") {
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					sWikifier(`당신의 한쪽 손이 당신의 페니스를 육봉 끝에서 끝까지 위아래로 거칠게 펌프질한다.`);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					fragment.append(span(`당신의 한쪽 손이 손가락들을 당신의 육봉 위아래로 움직이면서, 살짝 자극하자 음란한 따뜻함이 생겨난다.`));
				} else {
					sWikifier(`당신의 한쪽 손이 부자연스러운 움직임으로 당신의 페니스를 육봉 끝에서 끝까지 애무한다.`);
				}
			}
			break;
		case "mbreastW":
			...
			if (V.player.breastsize < 2) {
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					sWikifier(
						`당신의 손이 당신의 민감한 젖꼭지를 견디지 못할 정도로 희롱하자, 손가락이 스칠 때 마다 흥분의 충격이 당신의 몸을 타고 달린다.`
					);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					sWikifier(
						`당신의 손이 당신의 <<breasts>>을 애무하며 손가락으로 유륜 주위를 둥글게 문지르면서, 가끔씩 젖꼭지를 살짝 꼬집는다.`
					);
				} else {
					sWikifier(`당신의 손이 당신의 <<breasts>>을 쓰다듬으며 손가락 사이로 젖꼭지를 비비면서, 음란한 따뜻함을 점점 커지게 한다.`);
				}
			} else if (V.player.breastsize < 5) {
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					sWikifier(
						`당신의 손이 <<breasts>>을 감싸고 당신의 민감한 젖꼭지를 견디지 못할 정도로 희롱하자, 손가락이 스칠 때 마다 흥분의 충격이 당신의 몸을 타고 달린다.`
					);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					sWikifier(
						`당신의 손이 당신의 <<breasts>>을 애무하며 손가락으로 유륜 주위를 둥글게 문지르면서, 가끔씩 젖꼭지를 살짝 꼬집는다.`
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					sWikifier(
						`당신의 손이 <<breasts>>을 감싸고 당신의 민감한 젖꼭지를 견디지 못할 정도로 희롱한다. 손가락이 스칠 때 마다 흥분의 충격이 당신의 몸을 타고 달린다.`
					);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					sWikifier(
						`당신의 손이 당신의 <<breasts>>을 애무하며 손가락으로 유륜 주위를 둥글게 문지르면서, 가끔씩 젖꼭지를 살짝 꼬집는다.`
					...
					sWikifier(`당신의 손이 당신의 <<breasts>>을 쓰다듬으며 손가락 사이로 젖꼭지를 비비면서, 당신은 음란한 따뜻함이 점점 커지는 것을 느낀다.`);
				}
			}
			if (V.milk_amount >= 1) {
				fragment.append(" ");
		...
		case "mvaginaW":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				switch (random(1, 3)) {
					case 1:
						sWikifier(`당신의 손가락들이 질에 꿈틀거리면서 들락날락하며, 갑작스럽게 날카로운 찌르기로 당신을 범한다.`);
						break;
					case 2:
						sWikifier(`당신의 클리토리스가 손가락들 사이에서 까질 듯이 비벼지며, 한 순간도 회복할 틈을 주기를 거부한다.`);
						break;
					case 3:
						sWikifier(`당신의 손가락들이 질 안에서 전율하며, 당신의 온몸을 음란한 진동으로 고문한다.`);
						break;
				}
			} else if (V.arousal >= (V.arousalmax / 5) * 3) {
				switch (random(1, 3)) {
					case 1:
						sWikifier(`당신의 손이 질을 탐색하며, 안으로 들어가기 위해 서로를 향해 갑자기 움직인다.`);
						break;
					case 2:
						sWikifier(`당신의 손이 거칠게 질을 손으로 쥐고, 한 손이 다른 손 위에서 떨린다.`);
						break;
					case 3:
						sWikifier(`당신의 손이 번갈아가며 클리토리스를 찌른다.`);
						break;
				}
			} else {
				switch (random(1, 3)) {
					case 1:
						sWikifier(`당신의 손가락들이 질을 희롱하며, 하나씩 연속으로 당신의 틈을 횡단한다.`);
						break;
					case 2:
						sWikifier(`당신의 손이 음순을 주무르며, 손가락들은 당신의 질 입구에서 씰룩거린다.`);
						break;
					case 3:
						sWikifier(`당신의 손이 허벅지를 애무하며, 천천히 비틀어 연다.`);
						break;
				}
			}
			break;
		case "mpenisstopW":
			...
			if (doubleAction) {
				...
				sWikifier(`당신은 손을 당신의 ${altText.penis}에서 치운다. 그 손이 떨린다.`);
			}
			break;
		case "mbreaststopW":
			clearAction();
			if (doubleAction) {
				sWikifier(`당신은 양손을 당신의 <<breasts>>에서 치운다. 양손이 떨린다.`);
			} else {
				sWikifier(`당신은 손을 당신의 <<breasts>>에서 치운다. 그 손이 떨린다.`);
			}
			break;
		case "mvaginastopW":
			clearAction();
			if (doubleAction) {
				sWikifier(`당신은 양손을 당신의 질에서 치운다. 양손이 떨린다.`);
			} else {
				sWikifier(`당신은 손을 당신의 질에서 치운다. 그 손이 떨린다.`);
			}
			break;
		case "mpickupdildo":
		...
		case "mdildostop":
			...
			if (doubleAction) {
				...
				fragment.append(span(`당신은 손의 ${handPost(arm, '의')} ${toyDisplay(altText.selectedToy, '을')} 내려놓는다.`, "lblue"));
			}
			break;
			...
			if (V.penisuse === 0 || V.penisuse === "stroker") {
				...
				if (V.earSlime.defyCooldown && V.earSlime.growth >= 100) {
					if (doubleAction) {
						...
						if (genitalsExposed()) {
							sWikifier(
								`당신은 노출된 페니스에 당신의 ${toyDisplay(
									altText.selectedToy,
									altText.selectedOtherToy
								)}를 앞뒤로 문지르다, 움직임을 멈춘다. <span class="red">당신은 아무것도 느낄 수가 없었다.</span>`
							);
						} else {
							sWikifier(
								`<span class="blue">당신은 페니스에 당신의 ${toyDisplay(
									altText.selectedToy,
									altText.selectedOtherToy
								)}를 앞뒤로 문지르며, 속옷 아래의 그 모양을 느낀다.</span>`
							);
						}
					} else {
						if (genitalsExposed()) {
							sWikifier(
								`당신은 당신의 ${toyDisplay(
									altText.selectedOtherToy
								)}를 잡고 당신의 페니스에 문지르다, 움직임을 멈춘다. <span class="red">당신은 아무것도 느낄 수가 없었다.</span>`
							);
						} else {
							sWikifier(
								`<span class="blue">당신은 당신의 ${toyDisplay(
									altText.selectedOtherToy
								)}를 잡고 당신의 페니스에 문지르며, 속옷 아래의 그 모양을 느낀다.</span>`
							);
						}
					}
				} else {
					...
					if (doubleAction) {
						...
						if (genitalsExposed()) {
							sWikifier(
								`<span class="blue">당신은 노출된 페니스에 당신의 ${toyDisplay(
									altText.selectedToy,
									altText.selectedOtherToy
								)}를 앞뒤로 문지르며 기대감에 몸을 떤다.</span>`
							);
						} else {
							sWikifier(
								`<span class="blue">당신은 페니스에 당신의 ${toyDisplay(
						...
						if (genitalsExposed()) {
							sWikifier(
								`<span class="blue">당신은 당신의 ${toyDisplay(
									altText.selectedOtherToy
								)}를 잡고 당신의 페니스에 문지르며, 기대감에 몸을 떤다.</span>`
							);
						} else {
							sWikifier(
								`<span class="blue">당신은 당신의 ${toyDisplay(
				...
				if (genitalsExposed()) {
					sWikifier(
						`당신은 당신의 ${toyDisplay(
							altText.selectedToy,
							altText.selectedOtherToy
						)}를 당신의 페니스에 문지르지만, 얼굴을 찌푸린다. <span class="red">당신은 아직까지 아무것도 느낄 수가 없었다.</span>.`
					);
				} else {
					sWikifier(
						`당신은 당신의 ${toyDisplay(
							altText.selectedToy,
							altText.selectedOtherToy
						)}를 당신의 페니스에 문지르며, 속옷 아래의 그 모양을 느낀다.`
					);
				}
			} else {
				wikifier("arousal", 100 * handsOn, "masturbationPenis");
				if (genitalsExposed()) {
					sWikifier(`당신은 당신의 ${toyDisplay(altText.selectedToy, altText.selectedOtherToy)}를 당신의 페니스에 문지르며, 기대감에 몸을 떤다.`);
				} else {
					sWikifier(
						`당신은 당신의 ${toyDisplay(
							altText.selectedToy,
		...
		case "mpenisstroker":
			...
			if (earSlimeDefy()) {
				...
				if (doubleAction) {
					...
					altText.selectedOtherToy = selectedToy(otherArm);
					sWikifier(
						`무언가 느끼도록 당신은 ${toyDisplay(altText.selectedToy, altText.selectedOtherToy)}로 당신의 페니스를 범하라고 강요된다.`
					);
				} else {
					sWikifier(`무언가 느끼도록 당신은 ${toyDisplay(altText.selectedToy)}로 당신의 페니스를 범하라고 강요된다.`);
				}
			} else if (V.earSlime.corruption >= 100 && V.earSlime.growth >= 100 && V.earSlime.focus === "impregnation") {
				...
				if (doubleAction) {
					...
					sWikifier(
						`<span class="purple">당신이 ${toyDisplay(
							altText.selectedToy,
							altText.selectedOtherToy
						)}로 쿠퍼액으로 뒤덮인 페니스를 거칠게 범하자,</span> <span class="lewd">넘쳐나는 쿠퍼액이 그 끝에서 튀어 날아간다.</span>`
					);
				} else {
					sWikifier(
						`<span class="purple">당신이 ${toyDisplay(
							altText.selectedToy
						)}로 쿠퍼액으로 뒤덮인 페니스를 거칠게 범하자,</span> <span class="lewd">음란한 따뜻함이 몸 전체에서 생겨난다.</span>`
					);
				}
			} else {
				...
				if (doubleAction) {
					...
					altText.selectedOtherToy = selectedToy(otherArm);
					sWikifier(`<span class="purple">당신은 ${toyDisplay(altText.selectedToy, altText.selectedOtherToy)}로 당신의 페니스를 범한다.</span>`);
				} else {
					sWikifier(`<span class="purple">당신은 ${toyDisplay(altText.selectedToy)}로 당신의 페니스를 범한다.</span>`);
				}
			}
			break;
		case "mpenisstopstroker":
			...
			if (doubleAction) {
				...
				V.penisuse = 0;
				altText.selectedOtherToy = selectedToy(otherArm);
				sWikifier(`<span class="purple">당신은 ${toyDisplay(altText.selectedToy, altText.selectedOtherToy)}을 당신의 페니스에서 치운다.</span>`);
			} else {
				sWikifier(`<span class="purple">당신은 손의 ${toyDisplay(altText.selectedOtherToy)}을 당신의 페니스에서 치운다.</span>`);
			}
			break;
		case "mbreastpump":
			...
			if (doubleAction) {
				...
				altText.selectedOtherToy = selectedToy(otherArm);
				sWikifier(
					`<span class="blue">당신은 착유기를
					
					
					<<breastsPost>> 위에 씌워, 모유를 짜 낼 준비를 한다.</span>`
				);
			} else {
				sWikifier(`<span class="blue">당신은 착유기를 <<breastsPost>> 위에 씌워, 모유를 짜 낼 준비를 한다.</span>`);
			}
			break;
		case "mbreastpumppump":
			...
			if (doubleAction) {
				altText.selectedOtherToy = selectedToy(otherArm);
				altText.toys = `당신은 <<breastsPost>>에 착유기들을 사용`;
			} else {
				altText.toys = `당신은 <<breastsPost>>에 착유기를 사용`;
			}
			if (V.lactating === 1) {
		...
		case "mstopbreastpump":
			...
			if (doubleAction) {
				V[otherArm + "arm"] = 0;
				altText.selectedOtherToy = selectedToy(otherArm, false);
				sWikifier(`<span class="purple">당신은 ${toyDisplay(altText.selectedToy, altText.selectedOtherToy)}를 당신의 <<breasts>>에서 치운다.</span>`);
			} else {
				sWikifier(`<span class="purple">당신은 손의 ${toyDisplay(altText.selectedOtherToy)}를 당신의 <<breasts>>에서 치운다.</span>`);
			}
			break;
		case "mchestvibrate":
			clearAction();
			...
			if (breastsExposed()) {
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					fragment.append(
						span(
							`당신의 젖꼭지는 ${altText.toyDisplay}로 당신이 견딜 수 있는 한 가장 세게 비비는데도 불구하고 계속 발기하면서, 그 진동으로 당신에게 끊임없는 쾌감을 주고 있다.`
						)
					);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					fragment.append(span(`당신은 손으로 ${altText.toyDisplay} 점점 단단해지는 젖꼭지를 비벼댄다.`));
				} else {
					fragment.append(
						span(
							`당신은 ${altText.toyDisplay}로 젖꼭지를 누르며, 그 진동이 계속되면서 음란한 따뜻함이 점점 커지는 것을 느낀다.`
						)
					);
				}
			} else {
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					sWikifier(
						`당신의 젖꼭지는 옷감을 통해 ${altText.toyDisplay} 비벼대는데도 불구하고, 당신의 윗옷 아래에서 발기해 있다.`
					);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					sWikifier(`당신은 윗옷을 통해 손의 ${altText.toyDisplay} 점점 단단해지는 젖꼭지를 비벼댄다.`);
				} else {
					sWikifier(
						`당신은 손의 ${altText.toyDisplay} 젖꼭지를 누른다. 당신의 윗옷이 사이에 있음에도 불구하고, 좋은 느낌이 든다.`
					);
				}
			}
			fragment.append(" ");
		...
		case "mpenisvibrate":
			...
			if (genitalsExposed()) {
				...
				if (V.player.virginity.penile === true) {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						fragment.append(
							span(`당신은 진동하는 ${altText.toyDisplay}로 당신의 동정 페니스를 당신의 포피가 허용하는 한 거칠게 위아래로 비벼댄다.`)
						);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						fragment.append(span(`당신은 ${altText.toyDisplay}로 당신의 동정 페니스를 위아래로 비벼대고, 그 진동은 당신을 빠르게 흥분시킨다.`));
					} else {
						sWikifier(`당신은 부드럽게 ${altText.toyDisplay}를 페니스 아래에 갖다대면서, 그 느낌을 즐긴다.`);
					}
				} else {
					if (V.arousal >= (V.arousalmax / 5) * 4) {
						sWikifier(`당신은 진동하는 ${altText.toyDisplay} 당신의 페니스를 위아래로 비벼댄다.`);
					} else if (V.arousal >= (V.arousalmax / 5) * 3) {
						sWikifier(`당신은 ${altText.toyDisplay} 당신의 페니스를 위아래로 비벼대고, 그 진동은 빠르게 강해지는 음란한 따뜻함을 만들어낸다.`);
					} else {
						sWikifier(`당신은 부드럽게 ${altText.toyDisplay}를 페니스 아래에 갖다대면서, 그 느낌을 즐긴다.`);
					}
				}
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					sWikifier(`당신은 천 너머를 통해 ${altText.toyDisplay} 당신의 페니스를 위아래로 비벼댄다.`);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					sWikifier(
						`당신은 ${altText.toyDisplay} 당신의 페니스를 위아래로 비벼대고, 그 진동은 천 너머를 통하는데도 불구하고 당신을 빠르게 흥분시킨다.`
					);
				} else {
					sWikifier(
						`당신은 부드럽게 ${altText.toyDisplay}를 페니스 아래에 갖다대면서, 옷이 사이에 있음에도 불구하고 그 느낌을 즐긴다.`
					);
				}
			}
			break;
		case "mvaginaclitvibrate":
			...
			if (genitalsExposed() && V.bugsinside === 1) {
				...
				sWikifier(
					`<span class="blue">당신은 부드럽게 ${altText.toyDisplay}로 클리토리스를 누르고, 그 진동은 당신 안의 벌레들이 기어다니는 느낌과 합쳐져 당신의 발가락을 움츠러들게 한다.</span>`
				);
			} else if (genitalsExposed()) {
				wikifier("arousal", 200 * handsOn, "masturbationVagina");
				wikifier("addVaginalWetness", 2 * handsOn);
				altText.start = `당신은 부드럽게 ${altText.toyDisplay}로 클리토리스를 누르고,`;
				if (V.mouth === "mdildomouth") {
					...
					sWikifier(`${altText.start} 그 느낌 때문에 나오는 부드러운 신음소리가 당신의 입을 막고 있는 재갈에 묻혀 나온다.`);
				} else {
				...
				sWikifier(
					`<span class="blue">당신은 속옷을 통해 ${altText.toyDisplay}로 클리토리스를 누르며, 옷감이 사이에 있음에도 불구하고 그 느낌을 즐긴다.</span>`
				);
			}
			break;
		case "mvaginaclitvibrateparasite":
			...
			if (genitalsExposed() && V.bugsinside === 1) {
				...
				wikifier("addVaginalWetness", 2 * handsOn);
				sWikifier(
					`<span class="blue">당신은 부드럽게 ${altText.toyDisplay}로 클리토리스 위의 기생충을 누르고, 그 진동은 빨리는 느낌과 당신 안의 벌레들이 기어다니는 느낌과 모두 합쳐져 당신의 발가락을 움츠러들게 한다.</span>`
				);
			} else if (genitalsExposed()) {
				wikifier("arousal", 200 * handsOn, "masturbationVagina");
				wikifier("addVaginalWetness", 2 * handsOn);
				altText.start = `당신은 부드럽게 ${altText.toyDisplay}로 클리토리스 위의 기생충을 누르고,`;
				if (V.mouth === "mdildomouth") {
					if (V.worn.face.type.includes("gag")) {
						altText.gag = V.worn.face.name;
					} else if (V.leftarm === "mdildomouth") {
				...
				if (V.worn.lower.vagina_exposed && V.worn.over_lower.vagina_exposed) wikifier("addVaginalWetness", 1 * handsOn);
				sWikifier(
					`<span class="blue">당신은 속옷을 통해 ${altText.toyDisplay}로 클리토리스 위의 기생충을 누르며, 그 반응으로 그것이 당신을 더 빨려고 하는 느낌을 즐긴다.</span>`
				);
			}
			break;
		case "mdildomouthentrance":
			if (V.mouth === 0 && (otherArmAction !== "mdildomouthentrance" || random(0, 100) > 50)) {
				...
				altText.selectedToy = selectedToy(arm);
				altText.toys = `당신은 ${toyDisplay(altText.selectedOtherToy)}를 당신의 입까지 가져오며,`;
		...
		case "mdildopiston":
			...
			altText.selectedToy = selectedToy(arm);
			altText.toyDisplay = toyDisplay(altText.selectedOtherToy);
			if (currentSkillValue("oralskill") < 100) {
				altText.beginner = altText.selectedToy.name.includes("small")
					? "그 적당한 크기가 당신 같은 초보자에게는 딱 맞다고 느낀다."
					: "너무 깊숙이 밀어넣지 않도록 조심한다.";
				fragment.append(span(`당신은 조심스럽게 ${altText.toyDisplay}를 입 속에서 앞뒤로 움직이고, ${altText.beginner}`));
			} else if (currentSkillValue("oralskill") < 200) {
				wikifier("arousal", 100, "masturbationOral");
				fragment.append(
					span(`당신은 ${altText.toyDisplay}를 입에 넣은 머리를 앞뒤로 재빠르게 움직이며, 그것이 당신의 입술과 혀를 비벼대며 주는 느낌을 즐긴다.`)
				);
			} else {
				wikifier("arousal", 200, "masturbationOral");
				fragment.append(
					span(
						`당신은 머리를 앞뒤로 재빠르게 움직이면서 솜씨좋게 ${altText.toyDisplay}를 핥고 희롱하며, 그것이 주는 음란한 느낌을 한껏 즐긴다.`
					)
				);
			}
			break;
		case "mdildomouth":
			...
			fragment.append(
				span(
					`당신은 ${toyDisplay(altText.selectedOtherToy)}를 입 속에 넣으며, 그것을 입술 사이로 찔러넣을 때 혀로 그것을 살짝 핥는다.`
				)
			);
			break;
		case "mvaginaentrance":
			...
			if (genitalsExposed() && V.bugsinside) {
				sWikifier(`<span class="blue">당신은 ${altText.fingers} 당신의 노출된 질 위로 문지르면서, 벌레들이 돌아다니는 것을 느낀다.</span>`);
				wikifier("addVaginalWetness", 2 * handsOn);
			} else if (genitalsExposed()) {
				sWikifier(`<span class="blue">당신은 ${altText.fingers} 당신의 노출된 질 위로 문지르면서 기대감에 몸을 떤다.</span>`);
				wikifier("addVaginalWetness", 2 * handsOn);
			} else {
				sWikifier(`<span class="blue">당신은 ${altText.fingers} 당신의 노출된 질 위로 문지르면서, 속옷 아래의 그 모양을 느낀다.</span>`);
				if (V.worn.lower.vagina_exposed && V.worn.over_lower.vagina_exposed) wikifier("addVaginalWetness", 1 * handsOn);
			}
			break;
		case "mvagina":
			if (V.vaginause === 0) {
				...
				if (hymenIntact) {
					sWikifier(`<span class="purple">당신은 당신의 온전한 처녀막에 닿을 때까지 ${altText.finger} 당신의 질에 밀어넣는다.</span>`);
				} else if (V.bugsinside) {
					sWikifier(`<span class="purple">당신은 ${altText.finger} 당신의 질에 밀어넣는다. 벌레들이 안에서 기어다니는 것이 느껴진다.</span>`);
				} else {
					sWikifier(`<span class="purple">당신은 당신의 질을 벌리면서 ${altText.finger} 밀어넣는다.</span>`);
				}
		...
		case "mvaginafingeradd":
			...
			if (V.bugsinside === 1) {
				if (V.fingersInVagina === V.vaginaFingerLimit) {
					...
					sWikifier(
						`<span class="lblue">당신은 당신의 질에 ${altText.finger} 밀어넣으며 질을 더욱 확장한다. 벌레들이 안에서 기어다니는 것이 느껴진다.</span>`
					);
				}
			} else {
				if (V.fingersInVagina === V.vaginaFingerLimit) {
					...
					sWikifier(`<span class="lblue">당신은 당신의 질에 ${altText.finger} 밀어넣으며 질을 더욱 확장한다.</span>`);
				}
			}
			fragment.append(fingersEffect(span, hymenIntact));
			break;
		case "mvaginafistadd":
			...
			sWikifier(
				`<span class="lblue">마지막으로 힘을 주어, 당신은 다섯 손가락 모두를 당신의 질에 밀어넣는다.</span> 당신은 당신의 근육이 삽입에 맞춰 벌어져 당신의 손을 감싸고 고동치는 것이 느껴진다.`
			);
			break;
		case "mvaginatease":
			clearAction();
			...
			if (V.bugsinside) {
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					if (V.vaginaArousalWetness >= 60) {
						...
						sWikifier(
							`당신이 <<print $fingersInVagina>>개의 ${altText.fingers} 당신의 질을 안팎으로 쑤시자, 애액이 곤충과 벌레들과 섞여서, 함께 흘러나온다.`
						);
					} else {
						sWikifier(`당신이 <<print $fingersInVagina>>개의 ${altText.fingers} 당신의 질을 안팎으로 쑤시자, 곤충과 벌레들이 흘러나온다.`);
					}
				} else if (V.arousal >= (V.arousalmax / 5) * 2) {
					sWikifier(
						`당신은 <<print $fingersInVagina>>개의 ${altText.fingers} 당신의 질을 안팎으로 쑤시며, 그 안의 곤충과 벌레들을 느낀다.`
					);
				} else {
					sWikifier(
						`당신은 주변의 벌레 몇 마리를 같이 눌러대며, 당신의 질 입구를 <<print $fingersInVagina>>개의 ${altText.fingers} 부드럽게 쑤신다.`
					);
				}
			} else {
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					if (V.vaginaArousalWetness >= 60) {
						wikifier("vaginaFluidActive");
						sWikifier(`당신이 <<print $fingersInVagina>>개의 ${altText.fingers} 당신의 질을 안팎으로 쑤시자, 애액이 흘러나온다.`);
					} else {
						sWikifier(`당신은 닿을 수 있는 가장 깊숙한 곳까지 밀어넣으며, <<print $fingersInVagina>>개의 ${altText.fingers} 당신의 질을 안팎으로 쑤신다.`);
					}
				} else if (V.arousal >= (V.arousalmax / 5) * 2) {
					sWikifier(
						`당신은 그리 깊게 넣지 않음에도 스릴을 느끼며, <<print $fingersInVagina>>개의 ${altText.fingers} 당신의 질을 안팎으로 쑤신다.`
					);
				} else {
					sWikifier(`당신은 당신의 질 입구를 <<print $fingersInVagina>>개의 ${altText.fingers} 부드럽게 쑤신다.`);
				}
			}
			break;
		case "mvaginafist":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				if (V.vaginaArousalWetness >= 60) {
					wikifier("vaginaFluidActive");
					sWikifier(`당신은 당신의 욱신거리는 질에 손 전체를 억지로 밀어넣는다. 애액이 당신의 손목을 타고 흘러내린다.`);
				} else {
					sWikifier(`당신은 당신의 욱신거리는 질에 손 전체를 억지로 밀어넣는다.`);
				}
			} else if (V.arousal >= (V.arousalmax / 5) * 2) {
				sWikifier(`당신은 당신의 질을 손 전체로 찔러댄다. 당신의 내벽이 손을 감싸며 움찔거린다.`);
			} else {
				sWikifier(`당신은 당신의 근육이 반복적으로 늘어나는 것을 느끼며, 당신의 질 안에서 주먹을 부드럽게 움직인다.`);
			}
			break;
		case "mvaginaclit":
			clearAction();
		...
		case "mvaginarub":
			...
			altText.fingers = handsOn === 2 ? "손가락들을" : "손가락을";
			if (genitalsExposed() && V.bugsinside) {
				sWikifier(`당신은 ${altText.fingers} 당신의 노출된 질 위에서 움직이며, 그 주변을 돌아다니는 벌레들을 느낀다.`);
				wikifier("addVaginalWetness", 2 * handsOn);
			} else if (genitalsExposed()) {
				sWikifier(`당신은 ${altText.fingers} 당신의 노출된 질 위에서 움직이며 기대감에 몸을 떤다.`);
				wikifier("addVaginalWetness", 2 * handsOn);
			} else {
				sWikifier(`당신은 ${altText.fingers} 당신의 질 위에서 움직이며, 속옷 아래의 그 모양을 느낀다.`);
				if (V.worn.lower.vagina_exposed && V.worn.over_lower.vagina_exposed) wikifier("addVaginalWetness", 1 * handsOn);
			}
			break;
		case "mvaginaclitparasite":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				fragment.append(
					span(`당신은 클리토리스 위의 기생충을 쥐어짜며, 그것이 당신에게 더 적극적으로 쾌감을 주면서 당신의 흥분감이 차오르는 것을 느낀다.`)
				);
			} else if (V.arousal >= (V.arousalmax / 5) * 3) {
				fragment.append(span(`당신은 ${altText.fingers} 클리토리스 위의 기생충을 희롱한다.`));
			} else {
				fragment.append(span(`당신은 ${altText.fingers} 클리토리스 위의 기생충을 비비고, 그것이 같은 방법으로 반응하며 음란한 기분을 쌓아나간다.`));
			}
			break;
		case "mvaginastop":
			clearAction("mrest");
			...
			if (doubleAction) {
				...
				sWikifier('<span class="lblue">당신은 당신의 양손을 질에서 치운다.</span>');
			} else {
				sWikifier(`<span class="lblue">당신은 당신의 손을 질에서 치운다.</span>`);
			}
			break;
		case "mvaginafingerremove":
			...
			if (V.fingersInVagina >= 1) {
				...
				sWikifier('<span class="lblue">당신은 당신의 질에서 손가락을 하나 꺼낸다.</span>');
			} else {
				clearAction("mvaginarub");
				V[arm + "arm"] = "mvaginaentrance";
				if (V.vaginause === "mfingers") V.vaginause = 0;
				sWikifier('<span class="lblue">당신은 당신의 질에서 손가락을 꺼낸다.</span>');
			}
			break;
		case "mvaginafistremove":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				sWikifier(
					'<span class="lblue">당신은 당신의 질에서 손 전체를 꺼낸다. 애액이 흘러나오며 당신의 근육들이 항의하듯 꿈틀거리는 것이 느껴진다.</span>'
				);
			} else if (V.arousal >= (V.arousalmax / 5) * 2) {
				sWikifier('<span class="lblue">당신은 당신의 질에서 손 전체를 꺼내며, 뭔가 비어 있는 듯한 느낌을 받는다.</span>');
			} else {
				sWikifier('<span class="lblue">당신은 당신의 질에서 손 전체를 꺼낸다. 당신의 근육들이 이완되는 것이 느껴진다.</span>');
			}
			break;
		case "mvaginaentrancedildo":
			...
			if (genitalsExposed()) {
				wikifier("addVaginalWetness", 2 * handsOn);
				sWikifier(`<span class="blue">당신은 노출된 질 위로 당신의 ${altText.toyDisplay}를 문지르며 기대감에 몸을 떤다.</span>`);
			} else {
				if (V.worn.lower.vagina_exposed && V.worn.over_lower.vagina_exposed) wikifier("addVaginalWetness", 1 * handsOn);
				sWikifier(`<span class="blue">당신은 질 위로 당신의 ${altText.toyDisplay}를 문지르며,  속옷 아래의 그 모양을 느낀다.</span>`);
			}
			break;
		case "mvaginadildo":
			...
			if (hymenIntact) {
				sWikifier(
					`<span class="purple">당신은 당신의 온전한 처녀막에 닿을 때까지 ${altText.lubricated}${altText.toyDisplay}를 당신의 질에 밀어넣는다.</span>`
				);
			} else if (V.bugsinside) {
				sWikifier(
					`<span class="purple">당신은 ${altText.lubricated}${altText.toyDisplay}를 당신의 질에 밀어넣는다. 벌레들이 안에서 기어다니는 것이 느껴진다.</span>`
				);
			} else {
				sWikifier(
					`<span class="purple">당신은 당신의 질을 벌리면서 ${altText.lubricated}${altText.toyDisplay}를 밀어넣는다.</span>`
				);
			}
			break;
		case "mvaginateasedildo":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				if (V.vaginaArousalWetness >= 60) {
					sWikifier(`당신이 ${altText.toyDisplay}로 당신의 ${altText.wet}질을 안팎으로 쑤시자, 애액이 흘러나온다.`);
				} else {
					sWikifier(`당신은 닿을 수 있는 가장 깊숙한 곳까지 밀어넣으며, ${altText.toyDisplay}로 당신의 ${altText.wet}질을 안팎으로 쑤신다.`);
				}
			} else if (V.arousal >= (V.arousalmax / 5) * 2) {
				sWikifier(`당신은 그리 깊게 넣지 않음에도 스릴을 느끼며, ${altText.toyDisplay}로 당신의 ${altText.wet}질을 안팎으로 쑤신다.`);
			} else {
				sWikifier(`당신은 당신의 ${altText.wet}질 입구를 ${altText.toyDisplay}로 부드럽게 쑤신다.`);
			}
			break;
		case "mvaginaclitdildo":
			...
			if (doubleAction) {
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					fragment.append(
						span(`당신은 부드럽게 당신의 ${altText.toyDisplay}로 클리토리스 끝을 쓸어내지만, 당신이 점점 더 민감해지며 그것은 점점 더 단단해진다.`)
					);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					fragment.append(span(`당신은 당신의 ${altText.toyDisplay}로 클리토리스 끝을 희롱한다.`));
				} else {
					fragment.append(span(`당신은 당신의 ${altText.toyDisplay}로 클리토리스를 비벼대며, 음란한 느낌을 키운다.`));
				}
			} else {
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					fragment.append(
						span(
							`당신은 당신의 ${toyDisplay(
								altText.selectedToy
							)}로 클리토리스를 누르면서 동그라미를 그리며 비벼대고, 당신의 흥분이 커져가는 것을 느낀다.`
						)
					);
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					fragment.append(span(`당신은 당신의 ${toyDisplay(altText.selectedToy)}로 클리토리스 끝을 희롱한다.`));
				} else {
					fragment.append(span(`당신은 당신의 ${toyDisplay(altText.selectedToy)}로 클리토리스를 비벼대며, 음란한 느낌을 키운다.`));
				}
			}
			break;
		case "mvaginarubdildo":
			...
			if (doubleAction) {
				...
				if (altText.selectedOtherToy.type.includes("vibrator")) wikifier("arousal", 50, "masturbationVagina");
				altText.toyDisplay = toyDisplay(altText.selectedToy, altText.selectedOtherToy);
				sWikifier(`당신은 노출된 질 위로 당신의 ${altText.toyDisplay}를 문지르며 기대감에 몸을 떨면서, 음란한 느낌을 키운다.`);
			} else {
				sWikifier(`당신은 노출된 질 위로 당신의 ${altText.toyDisplay}를 문지르며, 음란한 느낌을 키운다.`);
			}
			break;
		case "mvaginastopdildo":
			...
			if (doubleAction) {
				V[otherArm + "arm"] = 0;
				altText.selectedOtherToy = selectedToy(otherArm);
				sWikifier(`<span class="lblue">당신은 ${toyDisplay(altText.selectedToy, altText.selectedOtherToy)}를 당신의 질에서 치운다.</span>`);
			} else {
				sWikifier(`<span class="lblue">당신은 손의 ${toyDisplay(altText.selectedOtherToy)}를 당신의 질에서 치운다.</span>`);
			}
			break;
		case "mvaginaentrancedildofloor":
			...
			if (V.vaginause === 0) {
				...
				altText.selectedToy = selectedToy(arm, false);
				sWikifier(`<span class="purple">당신은 손의 ${toyDisplay(altText.selectedOtherToy)}를 당신의 질 아래 바닥에 세워놓는다.</span>`);
			}
			break;
		case "manusentrance":
			...
			altText.fingers = handsOn === 2 ? "손가락들을" : "손가락을";
			if (genitalsExposed()) {
				sWikifier(`<span class="blue">당신은 노출된 엉덩이까지 손을 뻗어 당신의 항문에 부드럽게 ${altText.fingers} 누른다.</span>`);
			} else {
				sWikifier(
					`<span class="blue">당신은 엉덩이까지 손을 뻗어 속옷 위로 당신의 항문에 부드럽게 ${altText.fingers} 누른다.</span>`
				);
			}
			break;
		case "manus":
			if ([0, "manus"].includes(V.anususe)) {
				...
				if (doubleAction) {
					...
					sWikifier(`<span class="purple">당신은 ${altText.lubricated}손가락 두개를 당신의 엉덩이 안으로 밀어넣는다.</span>`);
				} else {
					altText.lubricated =
						(arm === "left" && V.leftFingersSemen >= 1) || (arm === "right" && V.rightFingersSemen >= 1) ? "정액으로 번들거리는 " : "";
					sWikifier(`<span class="purple">당신은 ${altText.lubricated}손가락 하나를 당신의 엉덩이 안으로 밀어넣는다.</span>`);
				}
		...
		case "manusrub":
			...
			switch (random(0, 2)) {
				case 0:
					sWikifier(`당신은 ${altText.fingers} 엉덩이살 사이에 누른 채로 부드럽게 당신의 항문을 쿡쿡 찌른다.`);
					break;
				case 1:
		...
		case "manustease":
			...
			switch (random(0, 2)) {
				case 0:
					sWikifier(`당신은 ${altText.fingers} 사용해 부드럽게 당신의 엉덩이 안을 더듬는다.`);
					break;
				case 1:
					fragment.append(span(`당신은 천천히 ${altText.fingers} 당신의 항문에 넣었다 뺐다 한다.`));
					break;
				case 2:
					sWikifier(`당신은 ${altText.fingers} 사용해 당신의 엉덩이를 범한다. 당신은 그런 곳으로 자위하는 것에 외설스러운 느낌이 든다.`);
					break;
			}
			break;
		case "manusprostate":
		...
		case "manusstop":
			...
			if (doubleAction) {
				V[otherArm + "arm"] = 0;
				V.anususe = 0;
				sWikifier(`<span class="purple">당신은 당신의 엉덩이에서 양손을 뗀다.</span>`);
			} else {
				sWikifier(`<span class="purple">당신은 당신의 엉덩이에서 손을 뗀다.</span>`);
			}
			break;
		case "manusentrancedildo":
			...
			if (doubleAction) {
				...
				if (genitalsExposed()) {
					sWikifier(
						`<span class="blue">당신은 노출된 엉덩이까지 손을 뻗어 당신의 항문에 부드럽게 ${altText.toyDisplay}를 누른다.</span>`
					);
				} else {
					sWikifier(
						`<span class="blue">당신은 엉덩이까지 손을 뻗어 당신의 속옷 위로 항문에 부드럽게 ${altText.toyDisplay}를 누른다.</span>`
					);
				}
			} else {
				if (genitalsExposed()) {
					sWikifier(
						`<span class="blue">당신은 노출된 엉덩이까지 손을 뻗어 당신의 항문에 부드럽게 ${toyDisplay(
							altText.selectedOtherToy
						)}를 누른다.</span>`
					);
				} else {
					sWikifier(
						`<span class="blue">당신은 엉덩이까지 손을 뻗어 당신의 속옷 위로 항문에 부드럽게 ${toyDisplay(
							altText.selectedOtherToy
						)}를 누른다.</span>`
					);
				}
			...
			if (doubleAction) {
				...
				sWikifier(
					`<span class="purple">당신은 ${altText.lubricated}${toyDisplay(
						altText.selectedToy,
						altText.selectedOtherToy
					)}를 당신의 엉덩이에 밀어넣는다.</span>`
				);
			} else {
				altText.lubricated = (arm === "left" && V.leftFingersSemen >= 1) || (arm === "right" && V.rightFingersSemen >= 1) ? "정액으로 번들거리는 " : "";
				sWikifier(`<span class="purple">당신은 ${altText.lubricated}${toyDisplay(altText.selectedOtherToy)}를 당신의 엉덩이에 밀어넣는다.</span>`);
			}
			if (altText.lubricated.includes("semen")) V.semenInAnus = true;
			break;
		case "manusrubdildo":
			...
			if (doubleAction) {
				...
				switch (random(0, 2)) {
					case 0:
						sWikifier(`당신은 ${altText.toyDisplay}를 엉덩이살 사이에 누른 채로 부드럽게 당신의 항문을 쿡쿡 찌른다.`);
						break;
					case 1:
						sWikifier(`당신은 ${altText.toyDisplay}를 사용해 동그라미를 그리며 항문에 비벼댄다.`);
						break;
					case 2:
						sWikifier(`당신은 ${altText.toyDisplay}를 항문에 대고 누른다. 당신은 항문이 살짝 열리는 것을 느낀다.`);
						break;
				}
			} else {
				altText.toyDisplay = toyDisplay(altText.selectedToy);
				switch (random(0, 2)) {
					case 0:
						sWikifier(`당신은 ${toyDisplay(altText.selectedOtherToy)}를 엉덩이살 사이에 누른 채로 부드럽게 당신의 항문을 쿡쿡 찌른다.`);
						break;
					case 1:
						sWikifier(`당신은 ${toyDisplay(altText.selectedOtherToy)}를 사용해 동그라미를 그리며 항문에 비벼댄다.`);
						break;
					case 2:
						sWikifier(`당신은 ${toyDisplay(altText.selectedOtherToy)}를 항문에 대고 누른다. 당신은 항문이 살짝 열리는 것을 느낀다.`);
						break;
				}
			}
			break;
		case "manusteasedildo":
			...
			if (doubleAction) {
				...
				switch (random(0, 2)) {
					case 0:
						sWikifier(`당신은 ${altText.toyDisplay}를 사용해 부드럽게 당신의 엉덩이 안을 더듬는다.`);
						break;
					case 1:
						sWikifier(`당신은 천천히 ${altText.toyDisplay}를 당신의 항문에 넣었다 뺐다 한다.`);
						break;
					case 2:
						sWikifier(`당신은 ${altText.toyDisplay}를 사용해 당신의 엉덩이를 범한다. 당신은 그런 곳으로 자위하는 것에 외설스러운 느낌이 든다.`);
						break;
				}
			} else {
				switch (random(0, 2)) {
					case 0:
						sWikifier(`당신은 ${toyDisplay(altText.selectedOtherToy)}를 사용해 부드럽게 당신의 엉덩이 안을 더듬는다.`);
						break;
					case 1:
						sWikifier(`당신은 천천히 ${toyDisplay(altText.selectedOtherToy)}를 당신의 항문에 넣었다 뺐다 한다.`);
						break;
					case 2:
						sWikifier(`당신은 ${toyDisplay(altText.selectedOtherToy)}를 사용해 당신의 엉덩이를 범한다. 당신은 그런 곳으로 자위하는 것에 외설스러운 느낌이 든다.`);
						break;
				}
			}
			break;
		case "manusprostatedildo":
			...
			if (doubleAction) {
				...
				altText.toyDisplay = toyDisplay(altText.selectedToy, altText.selectedOtherToy);
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					fragment.append(span(`당신은 ${altText.toyDisplay}로 당신의 전립선을 문지르며, 정액을 짜내면서 몸을 부르르 떤다.`));
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					fragment.append(
						span(
							`당신은 ${altText.toyDisplay}로 당신의 전립선을 눌러, 거의 견딜 수 없을 정도로 기분 좋은 무방비한 느낌을 들게 한다.`
						)
					);
				} else {
					fragment.append(
						span(`당신은 ${altText.toyDisplay}로 당신의 전립선을 부드럽게 찌르고, 찌를 때마다 쾌감의 물결이 당신의 몸으로 퍼져나간다.`)
					);
				}
			} else {
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					fragment.append(span(`당신은 ${toyDisplay(altText.selectedToy)}로 당신의 전립선을 문지르며, 정액을 짜내면서 몸을 부르르 떤다.`));
				} else if (V.arousal >= (V.arousalmax / 5) * 3) {
					fragment.append(
						span(
							`당신은 ${toyDisplay(
								altText.selectedToy
							)}로 당신의 전립선을 눌러, 거의 견딜 수 없을 정도로 기분 좋은 무방비한 느낌을 들게 한다.`
						)
					);
				} else {
					fragment.append(
						span(
							`당신은 ${toyDisplay(
								altText.selectedToy
							)}로 당신의 전립선을 부드럽게 찌르고, 찌를 때마다 쾌감의 물결이 당신의 몸으로 퍼져나간다.`
						)
					);
				}
			}
		...
		case "manusstopdildo":
			...
			if (doubleAction) {
				V[otherArm + "arm"] = 0;
				altText.selectedOtherToy = selectedToy(otherArm);
				sWikifier(`<span class="purple">당신은 ${toyDisplay(altText.selectedToy, altText.selectedOtherToy)}를 당신의 엉덩이에서 치운다.</span>`);
			} else {
				sWikifier(`<span class="purple">당신은 손의 ${toyDisplay(altText.selectedOtherToy)}를 당신의 엉덩이에서 치운다.</span>`);
			}
			break;
		case "manusentrancedildofloor":
			...
			if (V.anususe === 0) {
				...
				altText.selectedToy = selectedToy(arm, false);
				fragment.append(span(`당신은 손의 ${toyDisplay(altText.selectedOtherToy)}를 당신의 항문 아래 바닥에 세워놓는다.`, "purple"));
			}
			break;
		case "mmouthstopdildo":
			...
			V.mouth = 0;
			altText.selectedToy = selectedToy(arm, false);
			fragment.append(span(`당신은 손의 ${toyDisplay(altText.selectedOtherToy)}를 당신의 입에서 치운다.`, "purple"));
			break;
		default:
			clearAction("mrest");
			break;
	...
	switch (V.mouthaction) {
		case "mbreastentrance":
			...
			if (breastsHeld > 1) {
				fragment.append(
					Wikifier.wikifyEval(
						`당신은 ${breastsFondle ? "잠시 가슴을 애무하는 것을 멈추고 양쪽 가슴을" : "양쪽 <<breasts>>을"} 입까지 들어올린다.`
					)
				);
			} else {
				fragment.append(
		...
		case "mbreastlick":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				...
				fragment.append(
					Wikifier.wikifyEval(
						`당신은 혀 끝으로 당신의 노출된 ${
							breastsHeld > 1 ? "유륜 주위에 동그라미를 그린다. 당신의 유두의" : "유륜 주위에 동그라미를 그린다. 당신의 유두의"
						} 그 반응으로 단단해진다.`
					)
				);
			} else {
				fragment.append(Wikifier.wikifyEval(`당신은 노출된 ${breastsHeld > 1 ? "유두를" : "유두를"} 핥는다.`));
			}
		...
		case "mbreastsuck":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				fragment.append(
					Wikifier.wikifyEval(
						`당신은 열광적으로 ${
							breastsHeld > 1 ? "당신의 발기한 양쪽 유두를" : "당신의 발기한 유두를"
				...
				fragment.append(
					Wikifier.wikifyEval(
						`당신은 노출된 ${
							breastsHeld > 1 ? "양쪽 유두 주위로 당신의 입술을 단단히 감싸고 빤다. 그것들이" : "유두 주위로 당신의 입술을 단단히 감싸고 빤다. 그것이"
						} 당신의 혀 위에서 단단해진다.`
					)
				);
			} else {
				fragment.append(Wikifier.wikifyEval(`당신은 노출된 ${breastsHeld > 1 ? "양쪽 유두를" : "유두를"} 빤다.`));
			}
			if (V.lactating === 1 && V.settings.breastFeedingEnabled === true) {
				fragment.append(" ");
				if (V.milk_amount >= 1) {
		...
		case "mpenisentrance":
			if (V.penisuse === 0) {
				...
				if (genitalsExposed()) {
					...
					sWikifier(`<span class="blue">당신은 당신의 페니스에 닿을 정도로 충분히 몸을 굽혀 당신의 혀로 그 끝을 핥는다.</span>`);
				} else {
					sWikifier(
						`<span class="blue">당신은 혀를 당신의 페니스 위로 움직${
							calculatePenisBulge() ? "이며, 속옷 아래의 툭 튀어나온 부분을 느낀다" : "인다"
						}.</span>`
					);
				}
			} else {
		...
		case "mchastityparasiteentrance":
			if (V.penisuse === 0) {
				...
				if (genitalsExposed()) {
					wikifier("arousal", 100, "masturbationGenital");
					sWikifier(`<span class="blue">당신은 당신의 기생충 정조대 페니스에 닿을 정도로 충분히 몸을 굽혀 당신의 혀로 그것을 핥는다.</span>`);
				} else {
					sWikifier(
						`<span class="blue">당신은 혀를 당신의 기생충 정조대 페니스 위로 움직${
							calculatePenisBulge() ? "이며, 속옷 아래의 툭 튀어나온 부분을 느낀다" : "인다"
						}.</span>`
					);
				}
		...
		case "mpenislick":
			...
			if (genitalsExposed()) {
				if (earSlimeDefy()) {
					...
					wikifier("pain", 1);
					additionalEffect.earSlimeDefy.pushUnique(V.player.virginity.penile === true ? "동정 페니스" : "페니스");
					sWikifier(`무언가 느끼도록 당신은 당신의 페니스를 거칠게 핥으라고 강요된다.`);
				} else if (V.earSlime.corruption >= 100 && V.earSlime.growth >= 100 && V.earSlime.focus === "impregnation") {
					wikifier("arousal", 400, "masturbationGenital");
					if (V.arousal >= V.arousalmax * (4 / 5)) {
						sWikifier("당신이 핥을 때마다 당신의 페니스는 쿠퍼액을 과도하게 뿜어내고, 당신은 그것을 삼켜야만 했지만, 당신은 멈추지 않는다.");
					} else if (V.arousal >= V.arousalmax * (3 / 5)) {
					...
					if (V.arousal >= V.arousalmax * (4 / 5)) {
						sWikifier("당신의 페니스는 당신이 핥을 때마다 씰룩거리지만, 당신은 멈추지 않는다.");
					} else if (V.arousal >= V.arousalmax * (3 / 5)) {
		...
		case "mpenistakein":
			...
			wikifier("arousal", 200, "masturbationGenital");
			if (V.penisHeight === 0) {
				sWikifier(`<span class="blue">당신은 당신의 페니스를 입에 넣어, 음란한 따끔거림을 당신의 척추를 타고 흐르게 한다.</span>`);
			} else {
				sWikifier(`<span class="blue">당신은 당신의 페니스 귀두부분을 입에 넣어, 음란한 따끔거림을 당신의 척추를 타고 흐르게 한다.</span>`);
			}
			break;
		case "mpenisdeepthroat":
			...
			sWikifier(`당신은 당신의 페니스를 당신 입 안으로 더 깊숙이 밀어넣는다. `);
			if (V.selfsuckDepth === V.penisHeight) {
				...
				if (altText.hands) sWikifier(`<span class="lblue">당신은 자리를 만들기 위해 ${altText.hands} 당신의 페니스에서 치운다.</span> `);
		...
		case "mpenispullback":
			...
			if (V.selfsuckDepth >= 2) {
				clearAction();
				sWikifier('<span class="lblue">당신은 당신의 페니스에서 머리를 세게 뒤로 당겨 그것의 일부를 당신의 목구멍에서 빼낸다.</span>');
				fragment.append(" ");
				fragment.append(deepthroateffects(span));
			} else if (V.selfsuckDepth === 1) {
				clearAction();
				sWikifier('<span class="lblue">당신은 당신의 페니스에서 머리를 뒤로 당겨 그것을 당신의 목구멍에서 빼낸다.</span>');
				fragment.append(" ");
				fragment.append(deepthroateffects(span));
			} else {
				clearAction("mpenisstop");
				sWikifier('<span class="lblue">당신은 당신의 페니스 귀두부분만 입에 남을 때까지 머리를 뒤로 당긴다.</span>');
			}
			break;
		case "mpenismouthoff":
			clearAction("mrest");
			V.mouth = "mpenisentrance";
			V.mouthstate = 0;
			sWikifier('<span class="lblue">당신은 당신의 페니스에서 입을 치운다.</span>');
			break;
		case "mpenissuck":
			clearAction();
			if (earSlimeDefy()) {
				...
				wikifier("pain", 1);
				additionalEffect.earSlimeDefy.pushUnique(V.player.virginity.penile === true ? "동정 페니스" : "페니스");
				sWikifier(`무언가 느끼도록 당신은 당신의 페니스를 거칠게 빨라고 강요된다.`);
			} else if (V.earSlime.corruption >= 100 && V.earSlime.growth >= 100 && V.earSlime.focus === "impregnation") {
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					if (V.selfsuckDepth <= 1) {
						sWikifier(
							"당신이 당신의 페니스 위에서 머리를 앞뒤로 움직이는 동안 쿠퍼액이 입 안으로 흘러들어와 당신은 그것을 끊임없이 삼킨다. 만족스러운 따뜻함이 당신의 배를 채운다."
						);
					} else {
						sWikifier(
							"당신이 당신의 페니스 위에서 머리를 앞뒤로 움직이는 동안 쿠퍼액의 폭포가 당신의 목구멍으로 흘러내린다. 만족스러운 따뜻함이 당신의 배를 채운다."
						);
					}
				} else {
					if (V.penisHeight === V.selfsuckDepth) {
						if (V.selfsuckDepth >= 2) {
							sWikifier(`당신의 목구멍이 육봉을 마사지하는 동안 당신은 당신의 페니스 밑동을 핥는다.`);
						} else {
							sWikifier(`당신은 ${altText.eagerly} 당신의 페니스를 빨면서 그 밑동을 핥는다.`);
						}
					} else if (V.selfsuckDepth >= 1) {
						sWikifier(`당신은 ${altText.eagerly} 당신의 페니스를 빨면서 육봉을 핥는다.`);
					} else {
						sWikifier(`당신은 ${altText.eagerly} 당신의 페니스를 빨면서 그 끝 주위를 핥는다.`);
					}
				}
			} else {
				wikifier("arousal", 200 + 50 * V.selfsuckDepth, "masturbationGenital");
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					if (V.selfsuckDepth <= 1) {
						sWikifier("당신이 당신의 페니스 위에서 머리를 앞뒤로 움직이는 동안 쿠퍼액이 입 안으로 흘러들어와 당신은 그것을 마신다.");
					} else {
						sWikifier("당신이 당신의 페니스 위에서 머리를 앞뒤로 움직이는 동안 쿠퍼액이 당신의 목구멍으로 흘러내린다.");
					}
				} else {
					if (V.penisHeight === V.selfsuckDepth) {
						if (V.selfsuckDepth >= 2) {
		...
		case "mchastityparasitelick":
			...
			if (V.earSlime.defyCooldown) {
				...
				wikifier("pain", 4);
				sWikifier(
					`당신이 기생충 페니스를 핥자, 각각, 기생충이 <span class="lewd">쾌감</span>과 <span class="red">고통</span>의 물결을 교차해 보낸다.<<gpain>>`
				);
				...
				if (V.arousal >= (V.arousalmax / 5) * 4) {
					sWikifier(
						`당신이 ${altText.eagerly} 기생충 페니스를 핥자, 각각, <span class="lewd">기생충이 당신의 페니스를 통해 쾌감의 물결을 보낸다.</span>`
					);
				} else {
					sWikifier(
						`당신이 ${altText.eagerly} 기생충 페니스를 핥자, 각각, <span class="lewd">기생충이 당신의 페니스를 통해 작은 쾌감의 물결을 보낸다.</span>`
					);
				}
			} else {
				...
				if (V.arousal >= (V.arousalmax / 5) * 3) {
					wikifier("arousal", 500, "masturbationGenital");
					sWikifier(
						`당신이 기생충 페니스를 핥으려 애쓰자, 각각, 기생충이 <span class="lewd">기생충이 쾌감의 물결을 당신의 몸 전체로 보내고</span>, 당신은 그것을 거의 참고 있기가 힘들다.`
					);
				} else {
					sWikifier(
						`당신이 ${altText.eagerly} 기생충 페니스를 핥자, 각각, <span class="lewd">기생충이 쾌감의 물결을 당신의 몸 전체로 보낸다.</span>`
					);
				}
			}
			break;
		case "mchastityparasitestop":
			...
			V.mouth = 0;
			V.penisuse = 0;
			sWikifier(`<span class="lblue">당신은 기생충 정조대 페니스에서 입을 치운다.</span>`);
			break;
		case "mvaginaentrance":
			if (V.vaginause === 0) {
				...
				if (genitalsExposed()) {
					...
					sWikifier(`<span class="blue">당신은 혀를 당신의 질 위에서 움직이며,  속옷 아래의 그 모양을 느낀다.</span>`);
				}
			} else {
				clearAction("mrest");
			}
		...
		case "mvaginalick":
			...
			wikifier("arousal", 100, "masturbationGenital");
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				sWikifier("당신은 당신의 질에서 나오는 애액을 핥으며 기대감에 몸을 떤다.");
			} else if (V.arousal >= (V.arousalmax / 5) * 3) {
				sWikifier("당신은 당신의 질을 핥으며, 더 닿기 어려운 곳까지 혀를 닿게 하려 노력한다.");
			} else {
				sWikifier("당신은 당신의 질을 핥는다.");
			}
			break;
		case "mvaginaclit":
			clearAction();
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				fragment.append(span("당신은 당신의 클리토리스를 빨면서 이로 부드럽게 비비며 기대감에 몸을 떤다."));
			} else if (V.arousal >= (V.arousalmax / 5) * 3) {
		...
		case "mvaginaclitparasite":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				fragment.append(
					span(
						`당신은 클리토리스 위의 기생충을 빨면서 이로 부드럽게 비비며 기대감에 몸을 떨고, 그 반응으로 그것이 당신을 더 빨려고 하는 느낌을 즐긴다.`
					)
				);
			} else if (V.arousal >= (V.arousalmax / 5) * 3) {
				fragment.append(span(`당신은 클리토리스 위의 기생충을 핥으면서 빨아대며, 그것이 같은 방법으로 당신에게 주는 쾌감을 즐긴다.`));
			} else {
				fragment.append(span(`당신은 클리토리스 위의 기생충을 핥는다.`));
			}
			break;
		case "mvaginastop":
			clearAction("mrest");
			V.mouth = 0;
			V.vaginause = 0;
			sWikifier('<span class="lblue">당신은 입을 당신의 질에서 치운다.</span>');
			break;
		case "maphropill":
			clearAction("mrest");
		...
		case "mdildolick":
			...
			if (V.mouth === "mdildomouthentrance") {
				if (currentSkillValue("oralskill") < 100) {
					fragment.append(span(`당신은 조심스럽게 ${altText.toyDisplay}의 끝을 핥으며, 혀로 그것을 최선을 다해 희롱하려 노력한다.`));
				} else if (currentSkillValue("oralskill") < 200) {
					wikifier("arousal", 100, "masturbationOral");
					fragment.append(span(`당신은 열정적으로 ${altText.toyDisplay}의 끝을 핥으며, 혀로 그것을 최선을 다해 희롱한다.`));
				} else {
					wikifier("arousal", 200, "masturbationOral");
					fragment.append(
						span(`당신은 솜씨좋게 ${altText.toyDisplay}의 끝에 키스하면서 핥으며, 입술과 혀로 지나칠 정도로 그것에 집중한다.`)
					);
				}
			} else {
				if (currentSkillValue("oralskill") < 100) {
					if (altText.selectedToy.name.includes("small")) {
						fragment.append(span(`당신은 어색하게 입 속에 있는 ${altText.toyDisplay}의 아래를 따라 혀를 좌우로 움직인다.`));
					} else {
						fragment.append(
							span(`당신은 어떻게든 ${altText.toyDisplay}를 따라 핥으려고 몸부림치지만, 그것의 두께가 당신의 혀를 입 아래로 눌러댄다.`)
						);
					}
				} else if (currentSkillValue("oralskill") < 200) {
					wikifier("arousal", 100, "masturbationOral");
					fragment.append(
						span(`당신은 입 속의 ${altText.toyDisplay}를 따라 혀를 좌우로 움직이며, 그 장난감의 가능한 많은 곳에 혀를 갖다대려고 노력한다.`)
					);
				} else {
					wikifier("arousal", 200, "masturbationOral");
					fragment.append(
						span(
							`당신은 솜씨좋게 입 속의 ${altText.toyDisplay}를 따라 혀를 좌우로 움직이며, 가능한 많은 곳에 혀를 갖다대려고 가끔씩 머리의 각도를 조정한다.`
						)
					);
				}
			}
		...
		case "mdildokiss":
			...
			altText.toyDisplay = toyDisplay(altText.selectedToy);
			if (currentSkillValue("oralskill") < 100) {
				fragment.append(span(`당신은 서투르게 ${altText.toyDisplay}의 육봉을 따라 키스한다.`));
			} else if (currentSkillValue("oralskill") < 200) {
				wikifier("arousal", 100, "masturbationMouth");
				fragment.append(span(`당신이 ${altText.toyDisplay}의 육봉을 따라 키스하자, 음란한 따뜻함이 당신 속에서 커져간다.`));
			} else {
				altText.virginity =
				...
				fragment.append(span(`당신은 사랑스럽게 ${altText.toyDisplay}의 육봉을 따라 한 줄로 키스하며, ${altText.virginity}`));
			}
			break;
		case "mdildosuck":
			clearAction();
			...
			altText.toyDisplay = toyDisplay(altText.selectedOtherToy);
			if (currentSkillValue("oralskill") < 100) {
				fragment.append(span(`당신은 최선을 다해 ${altText.toyDisplay}를 빨려고 노력한다.`));
			} else if (currentSkillValue("oralskill") < 200) {
				wikifier("arousal", 100, "masturbationOral");
				fragment.append(span(`당신은 열정적으로 ${altText.toyDisplay}를 빤다.`));
			} else {
				wikifier("arousal", 200, "masturbationOral");
				if (V.player.virginity.oral === true) {
					altText.virginity = "진짜 페니스의 느낌이 어떻게 다를지 궁금해한다.";
				} else if (V.ejactrait) {
					altText.virginity = "끝난 후 당신이 얻을 것이 없다는 사실에 약간 실망한다.";
				} else {
					altText.virginity = "그것이 진짜 물건이라고 상상한다.";
				}
				fragment.append(span(`당신은 솜씨좋게 ${altText.toyDisplay}를 빨고 희롱하면서, ${altText.virginity}`));
			}
			break;
		default:
			clearAction("mrest");
	...
	switch (V.penisHeight) {
		...
		case 1:
			switch (V.selfsuckDepth) {
				case 1:
					sWikifier("당신의 입술이 당신의 페니스 밑동에 닿으며 그 끝은 당신의 입 뒤쪽을 쿡쿡 찌른다.");
					break;
				default:
					fragment.append(span("Error: Impossible condition.", "red"));
					break;
		...
		case 2:
			switch (V.selfsuckDepth) {
				case 1:
					sWikifier("당신의 페니스 귀두부분이 당신의 목구멍 입구를 쿡쿡 찌른다.");
					break;
				case 2:
					sWikifier("당신의 입술이 당신의 페니스 밑동에 닿자 그 머리부분이 당신의 목구멍 안을 누른다.");
					break;
				default:
					fragment.append(span("Error: Impossible condition.", "red"));
					break;
		...
		case 3:
			switch (V.selfsuckDepth) {
				case 1:
					...
					break;
				case 2:
					sWikifier("당신의 페니스가 당신의 목구멍 벽을 확장시킨다.");
					break;
				case 3:
					sWikifier("당신의 입술이 당신의 페니스 밑동에 닿자 육봉이 당신의 목구멍을 가득 채운다.");
					break;
				default:
					fragment.append(span("Error: Impossible condition.", "red"));
					break;
...
function masturbationEffectsVaginaAnus({ span, otherElement, additionalEffect, selectedToy, toyDisplay, genitalsExposed, breastsExposed, hymenIntact }) {
	...
	switch (V.mouthaction) {
		case "mpenisflowerlick":
			...
			switch (random(1, 3)) {
				case 1:
					fragment.append(span("당신은 페니스 모양 식물을 거의 입 안으로 집어넣지만, 갑자기 불안감을 느낀다."));
					break;
				case 2:
					fragment.append(span("당신은 페니스 모양 식물의 끝을 핥으며 달콤한 액체를 삼킨다."));
					break;
				case 3:
					fragment.append(span("당신은 페니스 모양 식물의 끝을 핥는다."));
					break;
			}
		...
		case "mpenisflowersuckstop":
			...
			wikifier("drugs", 10);
			fragment.append(
				span("당신의 머리는 계속 위아래로 움직이며, 그 페니스 모양 식물을 빨아댄다. 모든 힘을 다해 보지만, 당신은 당신 자신을 멈출 수가 없다.", "red")
			);
			break;
	}
	...
	switch (V.vaginaaction) {
			...
			if (!genitalsExposed()) {
				...
				switch (random(1, 3)) {
					case 1:
						fragment.append(
							span(
								"갑작스러운 욕정의 폭발이 당신을 덮쳐, 당신은 거의 당신 자신에게 그 식물을 찔러넣을 뻔 한다. 당신은 마지막 순간에 그것을 멈추고, 부드럽게 그 식물을 당신의 질 입구 주위에 원을 그리며 문지른다."
							)
						);
						break;
					case 2:
						sWikifier("당신은 당신의 <<if $player.penisExist>>페니스를<<else>>클리토리스를<</if>> 그 식물에 대고 비빈다.");
						break;
					case 3:
						fragment.append(span("당신은 당신의 질을 그 페니스 모양 식물에 대고 비빈다."));
						break;
				}
			}
			if (V.anusaction === "mpenisflowerrub") {
		...
		case "mpenisflowerpenetrate":
			...
			if (V.player.virginity.vaginal === true) {
				...
				fragment.append(" ");
				sWikifier(
					'당신은 당신의 <span class="red">더이상 처녀가 아닌</span> 질이 그 식물을 받아들이기 위해 몸부림치자 거의 비명을 지를 뻔 하지만, 그 아픔은 한순간 사라진다.'
				);
			} else {
		...
		case "mpenisflowerstop":
			...
			V.vaginause = 0;
			V.moorPhallusPlant = 1;
			fragment.append(span("당신은 당신의 질에 그 페니스 모양 식물을 비벼대는 것을 그만둔다.", "lblue"));
			break;
		case "mpenisflowerbounce":
			...
			if (V.arousal >= (V.arousalmax / 5) * 4) {
				...
				fragment.append(span("당신은 페니스 모양 식물 위에서 위아래로 몸을 흔든다. 그 감각이 당신을 미쳐버리게 한다."));
			} else {
				fragment.append(span("당신은 부드럽게 페니스 모양 식물 위에서 위아래로 몸을 흔들고, 그것이 찔러올 때마다 쾌락의 파도가 당신의 몸으로 밀려들어온다."));
			}
			break;
	...
	switch (V.anusaction) {
			...
			if (!genitalsExposed()) {
				...
				switch (random(1, 3)) {
					case 1:
						...
						break;
					case 2:
						sWikifier("당신은 그 식물을 당신의 엉덩이살 사이에 대고 비빈다.");
						break;
					case 3:
						fragment.append(span("당신은 당신의 항문을 그 페니스 모양 식물에 대고 비빈다."));
						break;
				}
			}
			break;
		...
		case "mpenisflowerstop":
			...
			V.anususe = 0;
			V.moorPhallusPlant = 1;
			fragment.append(span("당신은 당신의 항문에 그 페니스 모양 식물을 비벼대는 것을 그만둔다.", "lblue"));
			break;
		case "mpenisflowerbounce":
			clearAction("anus");
