...
setup.feats = {
	...
	Kept: {
		...
		series: "",
		filter: ["All", "Social"],
		hint: "Hint: 부유한 후원자를 찾는다.",
	},
	"What Goes Around": {
		title: "인과응보",
		desc: "에이버리가 자신의 던전에 묶이도록 만들었다.",
		difficulty: 2,
		series: "",
		filter: ["All", "Social"],
		hint: "Hint: 부유한 후원자에게 역전한다.",
	},
	"Most Exclusive": {
		title: "특권층의 최정상",
		desc: "1년 치 예약자 명단이 있는 레스토랑에서 식사한다.",
		difficulty: 2,
		series: "",
		filter: ["All", "Social"],
		hint: "Hint: 발렌타인데이에 부유한 후원자와 데이트한다.",
	},
	"Pride Cometh": {
		title: "추락 전의 교만",
		desc: "에이버리의 탑을 완성시켰다.",
		...
		series: "",
		filter: ["All", "Social"],
		hint: "Hint: 부유한 후원자를 돕는다.",
	},
	"Haute Cuisine": {
		title: "오트 퀴진",
		desc: "에이버리에게 좋아하는 음식을 주었다.",
		difficulty: 2,
		series: "",
		filter: ["All", "Social"],
	},
	...
	"Gwylan the Bewitching": {
		...
		hint: "Hint: 호기심이 처녀를 죽인다.",
		filter: ["All", "Social"],
	},
	"Coven Comforts": {
		title: "마녀 집회의 위안",
		desc: "그윌란에게 좋아하는 음식을 주었다.",
		difficulty: 2,
		series: "",
		hint: "Hint: 악당을 위한 음식.",
		filter: ["All", "Social"],
	...
	"Warmest Winter": {
		title: "가장 따듯한 겨울",
		desc: "윈터의 가장 개인적인 이야기를 들었다.",
		difficulty: 2,
		series: "",
		hint: "Hint: 노인장이 과거를 기억하도록 돕는다.",
		filter: ["All", "Social"],
	},
	"Trials of Faith": {
		title: "믿음의 시련",
		desc: "이야기 '절망의 순환'의 모든 엔딩에 대해 들었다.",
		difficulty: 4,
		series: "",
		hint: "Hint: 진실은 많은 거짓말 속에 묻혀 있다.",
		filter: ["All", "Social"],
	},
	"First Verse": {
		title: "제 1절",
		desc: "그윌란이 숲 속의 생물을 정화하는 것을 도왔다.",
		difficulty: 1,
		series: "gwylanPurge",
		hint: "Hint: 상점 주인의 비밀을 알고, 가담한다.",
		filter: ["All", "Social"],
	},
	Wildsong: {
		title: "야생의 노래",
		desc: "사적인 결합을 통해 그윌란이 숲을 정화하는 것을 도왔다.",
		difficulty: 2,
		series: "gwylanPurge",
		hint: "Hint: 그윌란의 비밀을 더 깊이 파헤친다.",
		filter: ["All", "Social"],
	},
	Foxbane: {
		title: "선투구꽃",
		desc: "에덴의 가장 끔찍한 악몽을 목격한다.",
		difficulty: 2,
		series: "",
		hint: "Hint: 사냥꾼에게서 벗어나기 위해, 친구에게 도움을 요청한다.",
		filter: ["All", "Social"],
	},
	Neko: {
		title: "야옹~",
	...
	"Player of the Match": {
		title: "최고의 플레이",
		desc: "렌에게서 크리켓 공을 훔쳤다.",
		difficulty: 2,
		series: "",
		filter: ["All", "Discoveries-Town"],
		hint: "Hint: 범죄 파트너를 배신한다.",
	},
	"Ear Slime Lover": {
		title: "귀 슬라임 성애자",
		desc: "당신의 최고의 친구다.",
	...
	"Curious Attire": {
		title: "별난 옷",
		desc: "숲 상점의 특별한 옷들을 절반 해금했다.",
		difficulty: 2,
		series: "specialClothes",
		filter: ["All", "Special"],
		hint: "Hint: 승리와 고난에 대한 절반의 보상은 비슷하다.",
		softLockable: true,
	},
	"Wicked Wardrobe": {
		title: "사악한 옷장",
		desc: "숲 상점의 모든 특별한 옷들을 해금했다.",
		difficulty: 3,
		series: "specialClothes",
		filter: ["All", "Special"],
		hint: "Hint: 승리와 고난에 대한 모든 보상은 비슷하다.",
		softLockable: true,
	},
...
async function featsMergePre() {
	...
	const result = () => {
		if (!T.saveDataImportCount) {
			...
			$("#featsBeginText").html(`${T.saveDataImportCount}개의 세이브 파일이 감지되었습니다. 느린 기기에서는 시간이 다소 걸릴 수 있습니다.`);
		} else {
			$("#featsBeginText").html(`${T.saveDataImportCount}개의 세이브 파일이 감지되었습니다. 잠시만 기다려 주세요.`);
		}
...
function featsMerge() {
	...
	const result = () => {
		...
		loadingText.html("모든 업적 정보가 입력되었습니다.");
...
function setupFeatBoosts(force) {
	...
	const boostData = {
		money: {
			...
			cost: 5,
			maxMultiplier: 2,
			missing: "이 부스트는 '잔돈' 업적을 달성하면 해금됩니다",
		},
		grades: {
			name: "학교 성적",
			...
			cost: 15,
			max: 2,
			missing: "이 부스트는 '완벽한 성적표' 업적을 달성하면 해금됩니다",
		},
		skulduggery: {
			name: "속임수 기술 등급",
			required: ["Thief"],
			cost: 5,
			max: 4,
			missing: "이 부스트는 '도둑' 업적을 달성하면 해금됩니다",
		},
		dancing: {
			name: "춤 기술 등급",
			...
			cost: 5,
			max: 4,
			missing: "이 부스트는 '한 곡 추시겠어요?' 업적을 달성하면 해금됩니다",
		},
		swimming: {
			name: "수영 기술 등급",
			required: ["Aquanaut"],
			cost: 5,
			max: 4,
			missing: "이 부스트는 '잠수부' 업적을 달성하면 해금됩니다",
		},
		athletics: {
			name: "운동 기술 등급",
			required: ["Swift"],
			cost: 5,
			max: 4,
			missing: "이 부스트는 '재빠름' 업적을 달성하면 해금됩니다",
		},
		tending: {
			name: "관리 기술 등급",
			...
			cost: 5,
			max: 4,
			missing: "이 부스트는 '초록 손가락' 업적을 달성하면 해금됩니다",
		},
		greenThumb: {
			name: "초록 손가락 특성",
			required: ["Green Fingered"],
		...
		housekeeping: {
			...
			cost: 5,
			max: 4,
			missing: "이 부스트는 '집사' 업적을 달성하면 해금됩니다",
		},
		seduction: {
			name: "유혹 기술 등급",
			required: ["Seductress"],
			cost: 5,
			max: 4,
			missing: "이 부스트는 '요부' 업적을 달성하면 해금됩니다",
		},
		purity: {
			name: "일일 순결도 증가 보너스",
			...
			max: 5,
			exclusive: "impurity",
			missing: "이 부스트는 '천사처럼 걷기' 업적과 '추락하고, 추락하고, 추락하고...' 업적을 달성하면 해금됩니다",
		},
		impurity: {
			name: "일일 순결도 감소 보너스",
			required: ["Demon"],
			...
			max: 5,
			exclusive: "purity",
			missing: "이 부스트는 '악마같은 모습' 업적을 달성하면 해금됩니다",
		},
		newLife: {
			name: "새로운 생명",
			required: ["Broodmother Host", "Top Broodmother Host"],
			cost: 20,
			missing: "이 부스트는 숨겨진 업적을 달성하면 해금됩니다 (" + setup.feats["Broodmother Host"].hint + ")",
		},
		aNewBestFriend: {
			name: "새로운 절친",
			required: ["Ear Slime Lover", "Ear Slime Amalgam"],
			cost: 10,
			missing: "이 부스트는 숨겨진 업적을 달성하면 해금됩니다 (" + setup.feats["Ear Slime Lover"].hint + ")",
		},
		tattoos: {
			name: "문신",
			...
			cost: 5,
			max: 5,
			missing: "이 부스트는 '광고판' 업적과 '살아있는 캔버스' 업적을 달성하면 해금됩니다",
		},
		randomClothing: {
			name: "무작위 의상 추가",
			required: [],
		...
		specialClothing: {
			...
			cost: 0,
			missing: "이 부스트는 숨겨진 업적을 달성하면 해금됩니다 (" + setup.feats["Curious Attire"].hint + ")",
		},
		sexToys: {
			name: "섹스 장난감",
			required: ["Opened Pandoras Box", "Opened Pandoras Cocks"],
			cost: 30,
			missing: "이 부스트는 숨겨진 업적을 달성하면 해금됩니다 (" + setup.feats["Opened Pandoras Box"].hint + ")",
		},
	};
