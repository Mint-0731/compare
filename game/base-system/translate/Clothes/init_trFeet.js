function init_trFeet()
{
    setup.trClothes.feet = [
...

        {
            ...
            description: "보기보다 편안하지만, 무척 시끄럽다.",
            post: 1
        },
...

        {
            ...
            description: "아침의 졸음 속에서 길을 안내해 줄 것이다.",
            post: 1
        },

        {
            ...
            name_ko: "선물 포장지",
            variable: "giftwrap",
            description: "이걸 발에 두르는 건 악마같은 짓이다.",
            post: 1
        },
