	...
	if (!setup.trFurniture)
	{
		setup.trFurniture = {
			...
			'nopillow': {
				...
				koName: "'싫어' 베개",
				post: 1,
				description: "싫다는 건 있는 그대로의 뜻이다. 창문 턱에 놓아둘 수 있다.",
			},
			'penguinplushie': {
				name: "penguin plushie",
				koName: "펭귄 인형",
				post: 0,
				description: "폭신하고 안기 좋다. 창문 턱에 놓아둘 수 있다.",
			},
			'yespillow': {
				name: "consent cushion",
				koName: "'좋아' 베개",
				post: 1,
				description: "열정적인 동의. 창문 턱에 놓아둘 수 있다.",
			},
			/* ------------- DECORATIONS ------------- */
			'calendar': {
				name: "calendar",
			...
			'bannerfestive': {
				...
				koName: "축제 현수막",
				post: 0,
				description: "지금 열리고 있든 열리고 있지 않든, 어쨌거나 멋져 보인다.",
			},
			'bearplushie': {
