function trinit_namedNPC()
{
    if (!setup.trNamedNPCList)
	{
        ...
        setup.trNamedNPCList = [
            ...
            {
                name:"avery",
                title:["businessperson","businessman","businesswoman","crimson hound"],
                koname:"에이버리",
                kotitle:["비즈니스맨","비즈니스맨","비즈니스우먼","핏빛 사냥개"],
                post:1,
                titlepost:[0,0,0,1]
            },
            ...
            {
                name:"gwylan",
                title:["shopkeeper","curious"],
                koname:"그윌란",
                kotitle:["상점 주인","호기심 많은 자"],
                post:0,
                titlepost:[0,1]
            },
            ...
            {
                name:"remy",
                title:["farmer","high elk","scarred"],
                koname:"레미",
                kotitle:["농부","하이 엘크","흉터를 가진 자"],
                post:1,
                titlepost:[1,1]
            },
...
function trinit_bodypartList()
{
    if (!setup.trBodypartsList)
	{
        setup.trBodypartsList = [
			...
			{part:"penis",koPart:"페니스",post:1},
			{part:"clit",koPart:"클리토리스",post:1},
			{part:"anus",koPart:"항문",post:0},
			{part:"vagina",koPart:"질",post:1},
			{part:"vaginaoutside",koPart:"질 바깥",post:0},
...
function trinit_hairtype()
{
	...
	if (!setup.trHairtypeList)
	{
		setup.trHairtypeList = { 
			...
			"pigtails": "피그테일",
			"ponytail": "포니테일",
			"princess twintails": "공주님 트윈테일",
			"princess wave": "공주님 웨이브",
			"ribbon tail": "리본테일",	
