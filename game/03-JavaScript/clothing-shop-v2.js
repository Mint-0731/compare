...
function getFilterRevealOptions(type) {
	const optionsFrom = { 얌전한: 0, 지적인: 100, 우아한: 200, 편안한: 300, 유혹적인: 500, 음란한: 700, 야한: 900 };
	const optionsTo = { 얌전한: 0, 지적인: 100, 우아한: 200, 편안한: 300, 유혹적인: 500, 음란한: 700, 야한: 9999 };
...
function shopSearchReplacer(name) {
	return name.replace(/[^a-zA-Z가-힣\u4e00-\u9fa5' -]+/g, "");
}
