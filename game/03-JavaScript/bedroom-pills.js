...
setup.pills = [
	...
	},
	{
		...
		warning_label:
			"<span class='hpi_notice_label'>주의사항: 이 약의 임상단계에서 어떤 부작용도 보고되어 있지 않으며, 모든 안전 규정을 통과하였습니다. <span class='hpi_blur unselectable'>이 제약 회사는 거의 나를 끝내버리려고 하는 것 같아. 부작용이 보고되어 있지 않다고 ? 누구한테 농담하는 거야 ?!</span></span>",
			...
			if (item.name === itemName) {
				...
				<div id="hpi_desc">
					...
					<div id="hpi_desc_action">
						<div>
							<a id="hpi_take_pills" onclick="window.onTakeClick(${itemName}, ${itemType})">약을 먹는다</a>
						</div>
						<div>
