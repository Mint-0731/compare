...
const combatActionColours = {
	Default: {
		brat: [
			...
			/* feetaction */
			"run", "taunt", "hide", "feetresistW", "feetHold",
			/* mouthaction */
		...
		sub: [
			...
			/* feetaction */
			"grab", "vaginagrab", "grabrub", "legLock", "legLocked", "vaginagrabrub", "rub",
			/* mouthaction */
...
function pussyNames(override) {
	...
	if ((V.awareness >= 100 && !override) || override >= 1) names.push("질");
	if ((V.awareness >= 200 && V.purity < 900 && !override) || override >= 2) names.push("질");
